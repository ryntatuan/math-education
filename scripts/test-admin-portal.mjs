...
if (!ONLY_DB) {
  ...
  await test(
    ...
    async () => {
      ...
      assert(soSlide === 2705, `Mong đợi 2705 slide, đọc được ${soSlide}`);
      assert(
        gapKieu.size === 6,
  ...
  await test(
    ...
    async () => {
      ...
      assert(
        soSlide === 2705,
        `Mong đợi 2705 slide, đọc được ${soSlide} — bộ đọc dữ liệu tĩnh đã hỏng`,
      );
      assert(
        saiKieu.size === 0,
  ...
  await test(
    ...
    async () => {
      ...
      assert(
        ...
        `Cây DB sai quy mô: ${d.lop}/${d.chuong}/${d.bai}/${d.slide} — mong đợi 5/51/459/2705`,
      );
