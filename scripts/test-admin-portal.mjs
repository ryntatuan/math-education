...
if (!ONLY_DB) {
  ...
  await test(
    ...
    async () => {
      ...
      assert(soSlide === 2735, `Mong đợi 2735 slide, đọc được ${soSlide}`);
      assert(
        gapKieu.size === 6,
  ...
  await test(
    ...
    async () => {
      ...
      assert(
        soSlide === 2735,
        `Mong đợi 2735 slide, đọc được ${soSlide} — bộ đọc dữ liệu tĩnh đã hỏng`,
      );
      assert(
        saiKieu.size === 0,
  ...
  await test(
    ...
    async () => {
      ...
      const d = demCay(cay);
      assert(
        d.lop === 5 && d.chuong === 51 && d.bai === 460 && d.slide === 2735,
