...
if (!ONLY_DB) {
  ...
  await test(
    ...
    async () => {
      ...
      assert(soSlide === 2438, `Mong đợi 2438 slide, đọc được ${soSlide}`);
      assert(
        gapKieu.size === 6,
  ...
  await test(
    ...
    async () => {
      ...
      assert(
        soSlide === 2438,
        `Mong đợi 2438 slide, đọc được ${soSlide} — bộ đọc dữ liệu tĩnh đã hỏng`,
      );
      assert(
        saiKieu.size === 0,
  ...
  await test(
    ...
    async () => {
      ...
      const d = demCay(cay);
      assert(
        d.lop === 5 && d.chuong === 51 && d.bai === 459 && d.slide === 2438,
