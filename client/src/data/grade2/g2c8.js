  ...
  lessons: [
    {
      ...
      slides: [
        ...
        },
        {
          type: "visual",
          content: {
            text: "Viết gọn 2 + 2 + 2 = 6 thành 2 × 3 = 6",
            table: {
              headers: ["Khay", "Số quả"],
              rows: [
                ["Khay 1", 2],
    ...
    },
    {
      ...
      slides: [
          ...
          content: {
            ...
            numberLine: {
              ...
              hops: [
                ...
                // Đủ 5 nhịp cho “2 được lấy 5 lần” — bản cũ chỉ vẽ 3 nhịp
                {
                  from: 6,
                  to: 8,
                  label: "4",
        ...
        },
        {
          type: "visual",
          content: {
            text: "Viết phép nhân từ tổng các số hạng bằng nhau",
            table: {
      ...
      slides: [
        {
          ...
          content: {
            ...
            groupScene: {
              ...
              n: 5,
              k: 2,
              captionText: "5 con chim, mỗi con 2 cánh",
            },
          },
        },
        {
      ...
      slides: [
        {
          ...
          content: {
            ...
            groupScene: {
              ...
              emoji: "🌸",
              per: 5,
              captionText: "Có 45 bông hoa, mỗi bó 5 bông",
            },
          },
        },
        {
