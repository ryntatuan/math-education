      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Cộng lần lượt từ hàng đơn vị, đến hàng chục, rồi hàng trăm. Nếu từng hàng đều bé hơn 10 thì gọi là cộng KHÔNG NHỚ.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            "badge": "Khám Phá",
            "title": "Cộng có nhớ",
            "explanation": "Khi một hàng cộng lại được từ 10 trở lên, ta viết chữ số hàng đơn vị của kết quả và NHỚ 1 sang hàng liền trước.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bài toán 'có ... thêm ...' thì dùng phép cộng. Chú ý nhớ 1 khi cần.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Thư viện có 265 quyển sách, nhập thêm 148 quyển. Hỏi có tất cả bao nhiêu quyển sách?",
            "options": [
              313,
              402,
              413,
        ...
        },
        {
          ...
          "content": {
            "title": "Bé nhớ rất tốt:",
            "points": [
              "Cộng có thể phải nhớ nhiều lần.",
              "265 + 148 = 413."
            ],
            "mascotMood": "proud"
          }
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Trừ lần lượt từ hàng đơn vị, đến hàng chục, rồi hàng trăm. Nếu từng hàng đều trừ được thì gọi là trừ KHÔNG MƯỢN.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            "badge": "Khám Phá",
            "title": "Trừ có mượn",
            "explanation": "Khi chữ số của số bị trừ bé hơn chữ số cùng hàng của số trừ, ta MƯỢN 1 từ hàng bên trái.",
    ...
    },
    {
      ...
      "slides": [
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Cửa hàng có 420 kg gạo, đã bán 165 kg. Hỏi còn lại bao nhiêu ki-lô-gam gạo?",
            "options": [
              255,
              265,
              355,
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Muốn tìm số hạng chưa biết, lấy tổng trừ số hạng đã biết. Muốn tìm số bị trừ, lấy hiệu cộng số trừ. Muốn tìm số trừ, lấy số bị trừ trừ hiệu.",
        ...
        },
        {
          ...
          "content": {
            ...
            "answer": 175,
            "mascotHint": "Số hạng chưa biết = tổng − số hạng đã biết = 320 − 145 = 175."
          }
        },
        {
          "type": "quiz",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "'Cả hai đội' là gom lại thì dùng phép CỘNG. 'Đội Một hơn đội Hai bao nhiêu' là so sánh thì dùng phép TRỪ.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Đội Một trồng 245 cây, đội Hai trồng 168 cây. Hỏi cả hai đội trồng được bao nhiêu cây?",
            "options": [
              313,
              403,
              413,
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Với hai đội trên, đội Một trồng nhiều hơn đội Hai bao nhiêu cây?",
            "options": [
              77,
              87,
              123,
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé đã học cộng trừ không nhớ và có nhớ trong phạm vi 1 000.",
            "points": [
        ...
        },
        {
          ...
          "content": {
            ...
            "answer": 631,
            "mascotHint": "2+9=11 viết 1 nhớ 1; 7+5+1=13 viết 3 nhớ 1; 3+2+1=6. Kết quả 631."
          }
        },
        {
          "type": "quiz",
