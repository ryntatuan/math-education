export const g2c14 = {
  ...
  "description": "Ôn tập số trong phạm vi 1 000, bốn phép tính, hình học, đo lường, thống kê",
  "icon": "🎓",
  "color": "#06d6a0",
  "totalLessons": 9,
  "lessons": [
    ...
    },
    {
      ...
      "type": "learn",
      "description": "Ôn tập phép cộng, phép trừ trong phạm vi 100 trước khi lên lớp 3",
      "slides": [
        {
          "type": "story",
          "content": {
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Cộng: nhớ 1 khi hàng đơn vị vượt 10. Trừ: mượn 1 chục khi không đủ để trừ.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Vẫn tính từ phải sang trái, vẫn nhớ và mượn như đã học.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé đã học điểm, đoạn thẳng, đường thẳng, đường cong, ba điểm thẳng hàng, đường gấp khúc, tứ giác, khối trụ và khối cầu.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Đường gấp khúc gồm 3 đoạn dài 5 cm, 6 cm và 7 cm. Độ dài đường gấp khúc là bao nhiêu?",
            "options": [
              "11 cm",
              "18 cm",
              "13 cm",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Độ dài: cm, dm, m, km. Khối lượng: kg. Dung tích: l. Thời gian: giờ, phút, ngày, tuần, tháng.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Đọc biểu đồ tranh: đếm số hình rồi nhân với số lượng mỗi hình. Ba mức khả năng: chắc chắn, có thể, không thể.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Trên biểu đồ, mỗi hình là 4 quyển vở. Nhóm có 3 hình. Hỏi nhóm đó có bao nhiêu quyển vở?",
            "options": [
              7,
              12,
              34,
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Số đến 1 000; cộng trừ có nhớ trong phạm vi 100 và 1 000; phép nhân chia với bảng 2 và bảng 5; đo lường; hình học và thống kê.",
            "points": [
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Một cửa hàng có 250 quyển vở, bán đi 135 quyển. Hỏi còn lại bao nhiêu quyển vở?",
            "options": [
              115,
              125,
              135,
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Có 5 đĩa, mỗi đĩa 2 quả cam. Hỏi có tất cả bao nhiêu quả cam?",
            "options": [
              7,
              10,
              12,
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Đề cuối năm thường có: đọc viết số, so sánh số, đặt tính rồi tính, tìm thành phần chưa biết, bài toán có lời văn, hình học và thống kê.",
            "points": [
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Một hình vuông có cạnh dài 4 cm. Chu vi hình vuông là bao nhiêu?",
            "options": [
              "8 cm",
              "12 cm",
              "16 cm",
