export const g2c5 = {
  ...
  "description": "Điểm, đoạn thẳng, đường thẳng, đường cong, ba điểm thẳng hàng, đường gấp khúc, hình tứ giác",
  "icon": "📐",
  "color": "#8e7cc3",
  "totalLessons": 8,
  "lessons": [
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "ĐIỂM là một chấm nhỏ, được đặt tên bằng chữ in hoa: A, B, C... Nối hai điểm với nhau ta được một ĐOẠN THẲNG.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "ĐƯỜNG THẲNG là đường kéo dài mãi về hai phía, không có đầu mút. ĐƯỜNG CONG là đường uốn lượn, không thẳng.",
        ...
        },
        {
          ...
          "content": {
            ...
            "mascotHint": "Đoạn thẳng có hai đầu mút, đường thẳng kéo dài mãi không có đầu mút."
          }
        },
        {
          "type": "summary",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Ba điểm được gọi là THẲNG HÀNG khi chúng cùng nằm trên một đường thẳng.",
        ...
        },
        {
          ...
          "content": {
            ...
            "pointLine": {
              ...
              "formula": "A, B, C cùng nằm trên một đường thẳng ⇒ ba điểm THẲNG HÀNG"
            }
          }
        },
        {
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "ĐƯỜNG GẤP KHÚC gồm nhiều đoạn thẳng nối tiếp nhau, không cùng nằm trên một đường thẳng.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Muốn tính độ dài đường gấp khúc, ta cộng độ dài các đoạn thẳng của nó lại với nhau.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Đường gấp khúc ABCD có AB = 3 cm, BC = 4 cm, CD = 5 cm. Đường gấp khúc dài bao nhiêu?",
            "options": [
              "9 cm",
              "12 cm",
              "15 cm",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Đường gấp khúc có hai đoạn: đoạn thứ nhất 6 cm, đoạn thứ hai 8 cm. Đường gấp khúc dài bao nhiêu?",
            "options": [
              "2 cm",
              "14 cm",
              "48 cm",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Đặt thước sao cho vạch 0 trùng với điểm đầu. Chấm điểm thứ hai ở đúng vạch số cần vẽ, rồi nối hai điểm lại.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Muốn vẽ đoạn thẳng dài 5 cm, bé đặt vạch số mấy của thước vào điểm đầu?",
            "options": [
              "Vạch 0",
              "Vạch 1",
              "Vạch 5",
            ...
            "mascotHint": "Luôn đặt vạch 0 trùng với điểm đầu, rồi chấm điểm thứ hai ở vạch 5."
          }
        },
        {
          "type": "summary",
    ...
    },
    {
      ...
      "type": "learn",
      "description": "Ôn tập điểm, đoạn thẳng, ba điểm thẳng hàng, đường gấp khúc, tứ giác",
      "slides": [
        {
          "type": "story",
          "content": {
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Đường gấp khúc gồm 3 đoạn dài 2 cm, 3 cm và 4 cm. Độ dài đường gấp khúc là bao nhiêu?",
            "options": [
              "7 cm",
              "9 cm",
              "10 cm",
