// Data for Grade 2 (Lớp 2) — DỰNG LẠI THEO ĐÚNG SGK "Kết nối tri thức với cuộc sống"
//
// ══════════════════════════════════════════════════════════════════════════════
// VÌ SAO DỰNG LẠI
//
// Bản cũ có 10 chương, gộp lung tung và **dạy sai lớp** ba chỗ (đo 2026-09-21, xem
// `docs/curriculum_audit.md`):
//   • Dạy bảng nhân 3, 4 và bảng chia 3, 4 — SGK Toán 2 KHÔNG có. Bảng 3, 4 thuộc
//     Toán 3 (Bài 5, 6). SGK Toán 2 chỉ có: Bảng nhân 2, Bảng nhân 5, Bảng chia 2,
//     Bảng chia 5 (Bài 39, 40, 43, 44).
//   • Dạy "một phần hai/ba/tư/năm" — SGK Toán 2 KHÔNG có ở bất kỳ trang nào.
//     "Một phần mấy" là Toán 3 — Bài 14.
//   • Dạy "Mi-li-mét (mm)" — SGK Toán 2 chỉ có đề-xi-mét, mét, ki-lô-mét.
//     Mi-li-mét là Toán 3 — Bài 30.
//   • Thiếu hẳn "Tiền Việt Nam" (SGK Bài 56) và "Ôn tập học kì 1" (chủ đề 7).
//
// Bản mới: **14 chương = 14 chủ đề của SGK**, bài trong chương bám theo từng bài SGK.
//
// ──────────────────────────────────────────────────────────────────────────────
// ⚠️ ĐÂY LÀ FILE DỰNG DẦN. Chưa được app import (app vẫn đọc `grade2Data.js`).
// Khi đủ 14 chương mới đổi tên đè lên. Chạy `node scratch/inspect_content_shape.mjs`
// để kiểm trước khi đổi.
// ══════════════════════════════════════════════════════════════════════════════
...
export const grade2Data = {
  ...
  name: "Lớp 2",
  description:
    "Số đến 1000, cộng trừ có nhớ, phép nhân chia với bảng nhân 2 và 5, đo lường, hình học",
  icon: "🌿",
  color: "#51CF66",
  ageRange: "7-8 tuổi",
  chapters: [
    // ═══ CHỦ ĐỀ 1 — SGK Bài 1-6 ═══
    {
      id: "g2-c1",
      ...
      lessons: [
        {
          ...
          type: "learn",
          description:
            "Nhận biết số có hai chữ số gồm hàng chục và hàng đơn vị",
          slides: [
            {
              type: "story",
              content: {
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                answer: 26,
                mascotHint:
                  "Đi sang phải một vạch là cộng thêm 1: 25 + 1 = 26.",
              },
            },
            {
              type: "summary",
    ...
    // ═══ CHỦ ĐỀ 2 — SGK Bài 7-14 ═══
    {
      id: "g2-c2",
      name: "Chủ đề 2: Phép cộng, phép trừ trong phạm vi 20",
      description:
        "Phép cộng, phép trừ qua 10; bảng cộng, bảng trừ qua 10; bài toán về thêm, bớt, nhiều hơn, ít hơn",
      icon: "➕",
      color: "#f6c23e",
      totalLessons: 12,
      lessons: [
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Khi cộng hai số mà kết quả LỚN HƠN 10, ta gọi đó là phép cộng qua 10. Mẹo hay nhất là làm cho tròn 10 trước.",
            ...
            },
            {
              ...
              content: {
                ...
                tenFrame: {
                  ...
                  total: 10,
                  emoji: "🔵",
                  // `extra` = số ô ĐƯỢC THÊM: 4 = 1 ô bù cho đủ 10, còn 3 ô ngoài khung.
                  // Bản cũ ghi 3 nên hình chỉ vẽ 9 + 1 = 10 — MẤT phần "rồi 10 + 3".
                  extra: 4,
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                title: "Bù cho đủ 10",
                explanation:
                  "Nhìn số hạng thứ nhất, xem nó còn thiếu bao nhiêu để đủ 10. Rồi tách số hạng thứ hai ra đúng bấy nhiêu.",
            ...
            },
            {
              ...
              content: {
                ...
                tenFrame: {
                  ...
                  total: 10,
                  emoji: "🟣",
                  // `extra` = số ô ĐƯỢC THÊM: 5 = 2 ô bù cho đủ 10, còn 3 ô ngoài khung.
                  // Bản cũ ghi 2 nên hình dừng ở 10, bé không thấy phần "+ 3" của 8 + 5.
                  extra: 5,
            ...
            },
            {
              ...
              content: {
                ...
                options: ["3 và 2", "2 và 3", "1 và 4", "4 và 1"],
                answer: "3 và 2",
                mascotHint:
                  "7 thiếu 3 để đủ 10, nên tách 5 = 3 + 2: 7 + 3 = 10, 10 + 2 = 12.",
              },
            },
            {
              type: "quiz",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Đây là bảng các phép cộng trong phạm vi 20 mà kết quả lớn hơn 10. Học thuộc bảng này giúp bé tính nhẩm rất nhanh.",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                title: "Ba dạng bài",
                explanation:
                  "Bé sẽ gặp ba dạng: tính kết quả, tìm số còn thiếu, và chọn phép tính đúng theo tình huống.",
                points: [
                  "Tính kết quả: 9 + 7 = 16.",
            ...
            },
            {
              ...
              content: {
                ...
                answer: 7,
                mascotHint:
                  "9 + 1 = 10, cần thêm 6 nữa: vậy số cần điền là 1 + 6 = 7.",
              },
            },
            {
              type: "quiz",
              content: {
                question:
                  "Có 6 quả bóng xanh và 7 quả bóng đỏ. Hỏi có tất cả bao nhiêu quả bóng?",
                options: [12, 13, 14, 1],
                answer: 13,
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Khi bài toán nói THÊM, ĐƯỢC CHO THÊM, CÓ THÊM, thì số lượng tăng lên, ta dùng phép cộng.",
            ...
            },
            {
              ...
              content: {
                question:
                  "Trên cành có 7 con chim, thêm 5 con bay đến. Hỏi có tất cả bao nhiêu con chim?",
                options: [2, 11, 12, 13],
                answer: 12,
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Khi bài toán nói BỚT, LẤY ĐI, CHO ĐI, BAY ĐI, thì số lượng giảm xuống, ta dùng phép trừ.",
            ...
            },
            {
              ...
              content: {
                question:
                  "Có 14 quả bóng, cho đi 6 quả. Hỏi còn lại bao nhiêu quả bóng?",
                options: [6, 7, 8, 20],
                answer: 8,
            ...
            },
            {
              ...
              content: {
                question:
                  "Trên cây có 15 quả cam, hái xuống 7 quả. Trên cây còn lại bao nhiêu quả cam?",
                options: [7, 8, 9, 22],
                answer: 8,
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Cả cộng và trừ qua 10 đều có cùng một mẹo: đưa về số 10 trước rồi tính tiếp.",
                points: [
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                title: "Trừ qua 10",
                explanation:
                  "Khi trừ mà ta phải mượn 1 chục, ta gọi đó là phép trừ qua 10. Mẹo: trừ về đủ 10 trước.",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Bảng này gồm các phép trừ mà số bị trừ lớn hơn 10. Bé có thể học từ bảng cộng: 9 + 2 = 11 nên 11 − 2 = 9.",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Bé sẽ gặp dạng tính kết quả và dạng tìm số còn thiếu.",
                points: [
                  "Tính kết quả: 17 − 9 = 8.",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Muốn biết hơn hoặc kém bao nhiêu đơn vị, ta luôn lấy SỐ LỚN trừ SỐ BÉ.",
            ...
            },
            {
              ...
              content: {
                question:
                  "Mai có 9 nhãn vở, Lan có 5 nhãn vở. Lan ít hơn Mai bao nhiêu nhãn vở?",
                options: [4, 5, 9, 14],
                answer: 4,
            ...
            },
            {
              ...
              content: {
                question:
                  "Lớp 2A trồng được 14 cây, lớp 2B trồng được 9 cây. Lớp 2A trồng nhiều hơn lớp 2B bao nhiêu cây?",
                options: [4, 5, 6, 23],
                answer: 5,
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Bé đã học cộng qua 10, bảng cộng qua 10, trừ qua 10, bảng trừ qua 10 và hai loại bài toán có lời văn.",
                points: [
            ...
            },
            {
              ...
              content: {
                question:
                  "Có 8 quả bóng xanh và 6 quả bóng đỏ. Hỏi bóng xanh nhiều hơn bóng đỏ bao nhiêu quả?",
                options: [2, 6, 8, 14],
                answer: 2,
            ...
            },
            {
              ...
              content: {
                ...
                answer: 8,
                mascotHint:
                  "Số hạng còn thiếu = tổng − số hạng đã biết = 15 − 7 = 8.",
              },
            },
            {
              type: "summary",
    ...
    // ═══ CHỦ ĐỀ 3 — SGK Bài 15-18 ═══
    {
      id: "g2-c3",
      name: "Chủ đề 3: Làm quen với khối lượng, dung tích",
      description: "Ki-lô-gam, lít và thực hành đo khối lượng, dung tích",
      icon: "⚖️",
      color: "#38b6ff",
      totalLessons: 6,
      lessons: [
        {
          id: "g2-c3-l1",
          title: "Bài 1: Ki-lô-gam (kg) — đơn vị đo khối lượng",
          type: "learn",
          description: "Nhận biết đơn vị ki-lô-gam và cách viết tắt",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "Rô-bốt bế quả dưa hấu thấy nặng quá! Làm sao biết nó nặng bao nhiêu nhỉ? 🤔",
              },
            },
            {
              type: "concept",
              content: {
                ...
                title: "Ki-lô-gam",
                explanation:
                  "Ki-lô-gam là đơn vị đo KHỐI LƯỢNG (độ nặng của vật). Viết tắt là kg, đọc là 'ki-lô-gam'.",
                rule: "Quả dưa hấu nặng 3 kg. Đọc là: ba ki-lô-gam.",
                points: [
                  "kg dùng để đo những vật nặng hơn, như gạo, đường, cặp sách.",
                  "1 kg viết là 1 kg — nhớ viết số trước, đơn vị sau.",
                  "Vật nhẹ hơn ki-lô-gam thì dùng gam, bé sẽ học ở lớp 3.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                options: ["kg", "kal", "kilo", "g"],
                answer: "kg",
                mascotHint: "Ki-lô-gam viết tắt là kg.",
              },
            },
            {
              type: "quiz",
              content: {
                question:
                  "Quả dưa hấu nặng ba ki-lô-gam. Viết số đo đó thế nào?",
                options: ["3 kg", "kg 3", "3g", "30 kg"],
                answer: "3 kg",
                mascotHint: "Viết số trước rồi đến đơn vị: 3 kg.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Ki-lô-gam đo độ nặng của vật, viết tắt là kg.",
        ...
        {
          id: "g2-c3-l2",
          title: "Bài 2: Đọc số đo trên cân",
          type: "learn",
          description: "Đọc số đo khối lượng trên cân đĩa và cân đồng hồ",
          slides: [
            {
              type: "story",
              content: {
            ...
            },
            {
              ...
              content: {
                ...
                options: ["7 kg", "6 kg", "8 kg", "70 kg"],
                answer: "7 kg",
                mascotHint:
                  "Kim chỉ vạch mấy thì vật nặng bấy nhiêu ki-lô-gam: 7 kg.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Kim cân chỉ số nào thì vật nặng bấy nhiêu kg.",
        ...
        {
          id: "g2-c3-l3",
          title: "Bài 3: Lít (l) — đơn vị đo dung tích",
          type: "learn",
          description: "Nhận biết lít và dùng lít để đo sức chứa",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "Bình nước này chứa được bao nhiêu nước nhỉ? Ta đo bằng gì? 🥛",
              },
            },
            {
              type: "concept",
              content: {
                ...
                title: "Lít",
                explanation:
                  "Lít là đơn vị đo DUNG TÍCH, tức là đo xem một vật chứa được bao nhiêu chất lỏng. Viết tắt là l.",
                rule: "Chai nước chứa 2 l. Đọc là: hai lít.",
                points: [
                  "l dùng để đo nước, sữa, dầu ăn, nước mắm.",
                  "Ca đong có vạch chia giúp ta biết đã rót được bao nhiêu lít.",
                  "Cùng là đơn vị đo, nhưng kg đo độ nặng còn l đo sức chứa.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                options: [
                  "Sức chứa chất lỏng như nước, sữa",
                  "Độ nặng của vật",
                  "Độ dài của vật",
                  "Nhiệt độ",
                ],
                answer: "Sức chứa chất lỏng như nước, sữa",
                mascotHint:
                  "Lít đo dung tích — xem vật chứa được bao nhiêu chất lỏng.",
              },
            },
            {
              type: "quiz",
              content: {
                question: "Can dầu chứa năm lít. Viết số đo đó thế nào?",
                options: ["5 l", "l 5", "5kg", "5 m"],
                answer: "5 l",
                mascotHint: "Viết số rồi đến đơn vị: 5 l.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Lít đo dung tích (sức chứa chất lỏng), viết tắt là l.",
        ...
        {
          id: "g2-c3-l4",
          title: "Bài 4: Đọc số đo dung tích",
          type: "learn",
          description: "Đọc và viết số đo dung tích, so sánh các số đo",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Ca đong có vạch 1 l, 2 l, 3 l... Bé đọc giúp Rô-bốt nhé 📏",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Mẹo Nhớ",
                title: "Đọc số đo dung tích",
                explanation:
                  "Mực nước dâng đến vạch nào thì đó là số lít. So sánh hai số đo cùng đơn vị thì so như so hai số thường.",
                rule: "Mực nước dâng đến vạch 3 thì có 3 l nước. 3 l nhiều hơn 2 l nên 3 l > 2 l.",
                points: [
                  "Chỉ so sánh được khi cùng đơn vị: 3 l và 2 l.",
                  "3 l > 2 l; 1 l < 5 l.",
                  "Không được so 3 l với 3 kg — khác loại đơn vị.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                options: ["6 l", "4 l", "Hai số bằng nhau"],
                answer: "6 l",
                mascotHint: "6 > 4 nên 6 l lớn hơn 4 l.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Mực nước đến vạch nào là bấy nhiêu lít.",
        ...
        {
          id: "g2-c3-l5",
          title: "Bài 5: Thực hành và trải nghiệm với ki-lô-gam, lít",
          type: "learn",
          description: "Ước lượng và giải bài toán có đơn vị kg, l",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "excited",
                text: "Hôm nay Rô-bốt đi siêu thị cùng bé! Mình ước lượng xem vật nào nặng cỡ nào nhé 🛒",
              },
            },
            {
              type: "concept",
              content: {
                ...
                explanation:
                  "Ước lượng là đoán trước khối lượng hoặc dung tích, rồi kiểm tra lại bằng cân và ca đong.",
                rule: "Một túi đường nhỏ nặng khoảng 1 kg. Một hộp sữa nhỏ chứa khoảng 1 l.",
                points: [
                  "Bé thử đoán trước rồi mới cân để kiểm tra.",
                  "Bài toán có đơn vị kg, l: nhớ ghi đơn vị vào kết quả.",
                  "Ví dụ: 2 kg gạo thêm 3 kg gạo thì được 2 + 3 = 5 kg.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                question:
                  "Mẹ mua 2 kg gạo rồi mua thêm 3 kg gạo nữa. Hỏi mẹ mua tất cả bao nhiêu ki-lô-gam gạo?",
                options: ["1 kg", "5 kg", "6 kg", "23 kg"],
                answer: "5 kg",
                mascotHint: "2 + 3 = 5 kg gạo.",
              },
            },
            {
              type: "quiz",
              content: {
                question:
                  "Một can có 3 l nước, rót thêm 2 l nữa. Can có bao nhiêu lít nước?",
                options: ["1 l", "5 l", "6 l", "32 l"],
                answer: "5 l",
                mascotHint: "3 + 2 = 5 l nước.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Ước lượng trước, rồi cân hoặc đong để kiểm tra lại.",
        ...
        {
          id: "g2-c3-l6",
          title: "Bài 6: Luyện tập chung chủ đề 3",
          type: "learn",
          description: "Ôn tập ki-lô-gam và lít",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Bé đã biết đo độ nặng và đo sức chứa rồi! Cùng làm mấy câu nhé ✅",
              },
            },
            {
              type: "concept",
              content: {
                ...
                points: [
                  "Túi gạo nặng 5 kg — nói về độ nặng.",
                  "Bình nước chứa 5 l — nói về sức chứa.",
            ...
            },
            {
              type: "quiz",
              content: {
                question: "Việc nào dùng đơn vị lít?",
                options: [
                  "Đo lượng nước trong bình",
                  "Đo xem bé nặng bao nhiêu",
                  "Đo chiều cao của bé",
                  "Đo nhiệt độ ngoài trời",
                ],
                answer: "Đo lượng nước trong bình",
                mascotHint: "Nước là chất lỏng, đo bằng lít.",
              },
            },
            {
              type: "quiz",
              content: {
                question:
                  "Bao gạo 4 kg, bớt đi 1 kg. Bao gạo còn bao nhiêu ki-lô-gam?",
                options: ["3 kg", "4 kg", "5 kg", "41 kg"],
                answer: "3 kg",
                mascotHint: "4 − 1 = 3 kg.",
              },
            },
      ...
      lessons: [
        {
          id: "g2-c4-l1",
          title:
            "Bài 1: Phép cộng (có nhớ) số có hai chữ số với số có một chữ số",
          type: "learn",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Cộng hàng đơn vị trước; nếu từ 10 trở lên thì nhớ 1 sang hàng chục.",
                  "27 + 5 = 32.",
                ],
                mascotMood: "proud",
              },
        ...
        },
        {
          id: "g2-c4-l3",
          title:
            "Bài 3: Phép cộng (có nhớ) số có hai chữ số với số có hai chữ số",
          type: "learn",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                answer: 63,
                mascotHint:
                  "8 + 5 = 13 viết 3 nhớ 1; 3 + 2 + 1 = 6. Kết quả 63.",
              },
            },
            {
              type: "quiz",
              content: {
                ...
                answer: 65,
                mascotHint:
                  "7 + 8 = 15 viết 5 nhớ 1; 4 + 1 + 1 = 6. Kết quả 65.",
              },
            },
            {
              type: "summary",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                answer: 83,
                mascotHint:
                  "6 + 7 = 13 viết 3 nhớ 1; 5 + 2 + 1 = 8. Kết quả 83.",
              },
            },
            {
              type: "quiz",
              content: {
                ...
                answer: 38,
                mascotHint:
                  "9 + 9 = 18 viết 8 nhớ 1; 1 + 1 + 1 = 3. Kết quả 38.",
              },
            },
            {
              type: "summary",
        ...
        },
        {
          id: "g2-c4-l6",
          title:
            "Bài 6: Phép trừ (có nhớ) số có hai chữ số cho số có một chữ số",
          type: "learn",
            ...
            },
            {
              ...
              content: {
                ...
                placeValue: {
                  ...
                  digits: [3, 2],
                  label:
                    "32 − 7: 2 không trừ được 7, mượn 1 chục thành 12; 12 − 7 = 5",
                },
              },
            },
            {
              ...
              content: {
                ...
                answer: 25,
                mascotHint:
                  "Mượn 1 chục: 12 − 7 = 5; 3 bớt 1 còn 2. Kết quả 25.",
              },
            },
            {
              type: "quiz",
        ...
        },
        {
          id: "g2-c4-l8",
          title:
            "Bài 8: Phép trừ (có nhớ) số có hai chữ số cho số có hai chữ số",
          type: "learn",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                mascotHint:
                  "Cùng nằm trên một đường thẳng thì gọi là thẳng hàng.",
              },
            },
            {
              type: "summary",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                answer: "3 đoạn",
                mascotHint:
                  "Bốn điểm A, B, C, D tạo thành ba đoạn: AB, BC, CD.",
              },
            },
            {
              type: "summary",
    ...
    // ═══ CHỦ ĐỀ 6 — SGK Bài 29-32 ═══
    {
      id: "g2-c6",
      name: "Chủ đề 6: Ngày - giờ, giờ - phút, ngày - tháng",
      description: "Xem đồng hồ, xem lịch, ngày tháng và các ngày trong tuần",
      icon: "🕐",
      color: "#f4a261",
      totalLessons: 7,
      lessons: [
        {
          id: "g2-c6-l1",
          title: "Bài 1: Ngày và giờ",
          type: "learn",
          description: "Nhận biết một ngày có 24 giờ và các buổi trong ngày",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Một ngày của Rô-bốt có sáng, trưa, chiều, tối. Bé biết một ngày có bao nhiêu giờ không? 🕐",
              },
            },
            {
              type: "concept",
              content: {
                ...
                rule: "1 ngày = 24 giờ. Buổi sáng từ 0 giờ đến 11 giờ, buổi chiều từ 12 giờ đến 23 giờ.",
                points: [
                  "Buổi sáng, buổi trưa, buổi chiều, buổi tối là các buổi trong ngày.",
                  "Ví dụ: 7 giờ sáng bé thức dậy; 9 giờ tối bé đi ngủ.",
                  "Trên đồng hồ, kim ngắn quay hết một vòng là hết 12 giờ. Quay hai vòng là hết một ngày.",
                ],
              },
            },
            {
        ...
        {
          id: "g2-c6-l2",
          title: "Bài 2: Giờ và phút",
          type: "learn",
          description: "Nhận biết một giờ có 60 phút và kim phút",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "Đồng hồ có hai kim đấy! Kim nào chỉ giờ, kim nào chỉ phút nhỉ? 🕰️",
              },
            },
            {
              type: "concept",
              content: {
                ...
                title: "Giờ và phút",
                explanation:
                  "Trên mặt đồng hồ, KIM NGẮN chỉ giờ, KIM DÀI chỉ phút. Một giờ có 60 phút.",
                rule: "1 giờ = 60 phút. Khi kim dài chỉ vào số 12 là đúng giờ. Khi kim dài chỉ vào số 6 là 30 phút.",
                points: [
                  "Kim ngắn đi một vòng hết 12 giờ; kim dài đi một vòng hết 60 phút.",
                  "Kim dài chạy từ số 1 đến số 2 là 5 phút; đến số 3 là 15 phút.",
                  "Nửa giờ = 30 phút.",
                ],
              },
            },
            ...
            },
            {
              ...
              content: {
                ...
                answer: 60,
                mascotHint: "1 giờ = 60 phút.",
              },
            },
            {
              type: "quiz",
              content: {
                question: "Trên mặt đồng hồ, kim nào chỉ phút?",
                options: ["Kim dài", "Kim ngắn", "Cả hai kim", "Không kim nào"],
                answer: "Kim dài",
                mascotHint: "Kim dài chỉ phút, kim ngắn chỉ giờ.",
              },
            },
            {
              type: "summary",
        ...
        {
          id: "g2-c6-l3",
          title: "Bài 3: Xem đồng hồ chỉ giờ và phút",
          type: "learn",
          description: "Đọc giờ đúng, giờ rưỡi và giờ hơn 15 phút",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Bây giờ là 3 giờ 30 phút. Bé xem kim đồng hồ chỉ thế nào nhé! 🕒",
              },
            },
            {
              type: "concept",
              content: {
                ...
                explanation:
                  "Đọc giờ trước, phút sau. Nhìn kim ngắn để biết giờ, nhìn kim dài để biết phút.",
                rule: "Kim ngắn chỉ số 3, kim dài chỉ số 6: đọc là 3 giờ 30 phút (ba giờ rưỡi).",
                points: [
                  "Kim dài ở số 12: 3 giờ 00 phút.",
                  "Kim dài ở số 6: 3 giờ 30 phút.",
                  "Kim dài ở số 3: 3 giờ 15 phút (mười lăm phút).",
                  "Kim dài ở số 9: 3 giờ 45 phút.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                answer: "3 giờ 30 phút",
                mascotHint: "Kim ngắn số 3 là 3 giờ; kim dài số 6 là 30 phút.",
              },
            },
            {
              type: "quiz",
              content: {
                ...
                answer: "8 giờ 15 phút",
                mascotHint: "Kim ngắn số 8 là 8 giờ; kim dài số 3 là 15 phút.",
              },
            },
            {
              type: "summary",
              content: {
                ...
                points: [
                  ...
                  "Kim dài ở số 3 là 15 phút, số 6 là 30 phút, số 9 là 45 phút.",
                ],
                mascotMood: "celebrate",
              },
            },
        ...
        {
          id: "g2-c6-l4",
          title: "Bài 4: Ngày và tháng",
          type: "learn",
          description:
            "Nhận biết một năm có 12 tháng và số ngày trong mỗi tháng",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "Rô-bốt sinh nhật tháng 5. Bé sinh nhật tháng mấy nhỉ? 📅",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Khám Phá",
                title: "Một năm có 12 tháng",
                explanation:
                  "Một năm có 12 tháng, các tháng được đánh số từ 1 đến 12.",
                rule: "Tháng có 31 ngày: 1, 3, 5, 7, 8, 10, 12. Tháng có 30 ngày: 4, 6, 9, 11. Tháng 2 có 28 ngày (năm thường) hoặc 29 ngày (năm nhuận).",
                points: [
                  "Nhìn đốt ngón tay để nhớ tháng 31 ngày: chỗ lồi là 31 ngày, chỗ lõm là 30 ngày.",
                  "Tháng 2 là tháng đặc biệt, chỉ có 28 hoặc 29 ngày.",
            ...
            },
            {
              type: "quiz",
              content: {
                question: "Tháng 6 có bao nhiêu ngày?",
                options: [28, 30, 31, 29],
                answer: 30,
                mascotHint: "Tháng 6 thuộc nhóm tháng có 30 ngày: 4, 6, 9, 11.",
              },
            },
            {
              type: "summary",
        ...
        {
          id: "g2-c6-l5",
          title: "Bài 5: Xem lịch",
          type: "learn",
          description: "Đọc ngày, thứ trong tờ lịch tháng",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Tờ lịch tháng có các con số và các thứ. Bé đọc thử xem ngày 15 là thứ mấy nhé! 📅",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Thực Hành",
                title: "Đọc lịch tháng",
                explanation:
                  "Tờ lịch tháng ghi các ngày trong tháng. Mỗi cột là một thứ trong tuần; hàng trên cùng ghi tên các thứ.",
                rule: "Ngày 15 nằm ở cột ghi 'Thứ Ba' thì ngày 15 là thứ Ba.",
                points: [
                  "Cùng một cột là cùng một thứ trong tuần.",
                  "Ngày 1 của tháng có thể bắt đầu bằng bất kì thứ nào.",
                  "Một số tháng có 5 ngày Chủ nhật, một số tháng chỉ có 4.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                question:
                  "Trên tờ lịch tháng, các ngày nằm cùng một cột là cùng gì?",
                options: [
                  "Cùng một thứ trong tuần",
                  "Cùng một ngày",
                  "Cùng một tháng",
                  "Cùng một năm",
                ],
                answer: "Cùng một thứ trong tuần",
                mascotHint: "Mỗi cột là một thứ trong tuần.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Cùng một cột trên tờ lịch là cùng một thứ.",
                  "Một tuần có 7 ngày.",
                ],
                mascotMood: "proud",
              },
        ...
        {
          id: "g2-c6-l6",
          title: "Bài 6: Thực hành xem đồng hồ, xem lịch",
          type: "learn",
          description:
            "Vận dụng xem đồng hồ và xem lịch vào tình huống thực tế",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "excited",
                text: "Bé hãy lên thời khoá biểu cho buổi tối của mình nhé! 🕖",
              },
            },
            {
              type: "concept",
              content: {
                ...
                explanation:
                  "Muốn biết từ 7 giờ đến 8 giờ là bao lâu, bé lấy 8 − 7 = 1 giờ.",
                rule: "Từ 7 giờ đến 8 giờ: 8 − 7 = 1 giờ. Từ 7 giờ đến 9 giờ: 9 − 7 = 2 giờ.",
                points: [
                  "Buổi tối: 19 giờ = 7 giờ tối.",
                  "Từ 19 giờ đến 21 giờ là 2 giờ.",
                  "Sắp xếp công việc theo đúng giờ giúp bé không bị muộn.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                question:
                  "Bé bắt đầu học lúc 19 giờ và học xong lúc 20 giờ. Bé học trong bao lâu?",
                options: ["1 giờ", "2 giờ", "30 phút", "19 giờ"],
                answer: "1 giờ",
                mascotHint: "20 − 19 = 1 giờ.",
              },
            },
            {
              type: "quiz",
              content: {
                question: "19 giờ còn được đọc là mấy giờ tối?",
                options: [
                  "7 giờ tối",
                  "9 giờ tối",
                  "5 giờ chiều",
                ...
                answer: "7 giờ tối",
                mascotHint: "19 giờ = 12 + 7 nên là 7 giờ tối.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Muốn biết khoảng thời gian, lấy giờ sau trừ giờ trước.",
                  "19 giờ chính là 7 giờ tối.",
                ],
                mascotMood: "celebrate",
              },
            },
        ...
        {
          id: "g2-c6-l7",
          title: "Bài 7: Luyện tập chung chủ đề 6",
          type: "learn",
          description: "Ôn tập ngày giờ, giờ phút, ngày tháng",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Bé đã biết xem đồng hồ và xem lịch rồi! Tổng kết nào 🎉",
              },
            },
            {
              type: "concept",
              content: {
                ...
                explanation:
                  "Bé đã học: 1 ngày = 24 giờ, 1 giờ = 60 phút, một năm có 12 tháng và cách xem lịch.",
                points: [
                  "Đọc đồng hồ: giờ trước, phút sau.",
            ...
            },
            {
              ...
              content: {
                ...
                answer: "10 giờ 30 phút",
                mascotHint:
                  "Kim ngắn số 10 là 10 giờ; kim dài số 6 là 30 phút.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "1 ngày = 24 giờ; 1 giờ = 60 phút; 1 tuần = 7 ngày.",
    ...
    // ═══ CHỦ ĐỀ 7 — SGK Bài 33-36 ═══
    {
      id: "g2-c7",
      name: "Chủ đề 7: Ôn tập học kì 1",
      description:
        "Ôn tập phép cộng trừ trong phạm vi 20 và 100, hình phẳng, đo lường",
      icon: "📖",
      color: "#90be6d",
      totalLessons: 6,
      lessons: [
        {
          id: "g2-c7-l1",
          title: "Bài 1: Ôn tập phép cộng, phép trừ trong phạm vi 20",
          type: "learn",
          description:
            "Ôn lại cộng trừ qua 10 và bảng cộng, bảng trừ trong phạm vi 20",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Hết học kì 1 rồi! Mình cùng ôn lại những gì đã học nhé 📖",
              },
            },
            {
              type: "concept",
              content: {
                ...
                explanation:
                  "Mẹo quan trọng nhất: đưa về số 10 trước rồi tính tiếp.",
                rule: "Cộng: 9 + 5 = 9 + 1 + 4 = 14. Trừ: 14 − 5 = 14 − 4 − 1 = 9.",
                points: [
                  "Từ 9 + 5 = 14, bé viết ngay được 14 − 5 = 9 và 14 − 9 = 5.",
                  "Bảng cộng qua 10 có kết quả từ 11 đến 18.",
            ...
            },
            {
              ...
              content: {
                ...
                options: [13, 14, 15, 16],
                answer: 15,
                mascotHint: "8 + 2 = 10, còn 5 nữa: 10 + 5 = 15.",
              },
            },
            {
              type: "quiz",
            ...
            },
            {
              ...
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Cộng trừ qua 10 đều làm tròn 10 trước.",
                  "8 + 7 = 15; 16 − 9 = 7.",
                ],
                mascotMood: "proud",
              },
        ...
        },
        {
          ...
          type: "learn",
          description: "Ôn lại cộng trừ có nhớ và không nhớ trong phạm vi 100",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "Bé còn nhớ khi nào phải nhớ 1 và khi nào phải mượn 1 chục không? 🤔",
              },
            },
            {
              type: "concept",
              content: {
                ...
                title: "Nhớ và mượn",
                explanation:
                  "Cộng: nếu hàng đơn vị từ 10 trở lên thì NHỚ 1 sang hàng chục. Trừ: nếu hàng đơn vị không trừ được thì MƯỢN 1 chục.",
                rule: "38 + 25 = 63 (8 + 5 = 13, nhớ 1). 52 − 27 = 25 (mượn 1 chục: 12 − 7 = 5).",
                points: [
                  "Luôn đặt tính thẳng cột và tính từ phải sang trái.",
                  "Thử lại bằng phép tính ngược để chắc chắn đúng.",
                  "Bài toán 'thêm' thì cộng, 'bớt' thì trừ, 'hơn kém' thì trừ.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                answer: 84,
                mascotHint:
                  "6 + 8 = 14 viết 4 nhớ 1; 4 + 3 + 1 = 8. Kết quả 84.",
              },
            },
            {
              type: "quiz",
              content: {
                question: "83 − 47 bằng bao nhiêu?",
                options: [36, 44, 46, 130],
                answer: 36,
                mascotHint: "13 − 7 = 6; 8 bớt 1 còn 7, 7 − 4 = 3. Kết quả 36.",
              },
            },
            {
              type: "summary",
        ...
        {
          id: "g2-c7-l3",
          title: "Bài 3: Ôn tập hình phẳng",
          type: "learn",
          description: "Ôn lại đoạn thẳng, đường gấp khúc, hình tứ giác",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Các hình phẳng đang chờ bé ôn lại đấy! 📐",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Ôn Tập",
                title: "Nhớ lại các hình đã học",
                explanation:
                  "Bé đã học điểm, đoạn thẳng, đường thẳng, đường cong, ba điểm thẳng hàng, đường gấp khúc và hình tứ giác.",
                rule: "Độ dài đường gấp khúc bằng tổng độ dài các đoạn thẳng của nó.",
                points: [
                  "Đoạn thẳng có hai đầu mút; đường thẳng kéo dài mãi.",
                  "Ba điểm thẳng hàng khi cùng nằm trên một đường thẳng.",
                  "Hình tứ giác có 4 cạnh, 4 đỉnh.",
            ...
            },
            {
              ...
              content: {
                question:
                  "Đường gấp khúc gồm 3 đoạn dài 4 cm, 5 cm và 6 cm. Độ dài đường gấp khúc là bao nhiêu?",
                options: ["10 cm", "15 cm", "16 cm", "45 cm"],
                answer: "15 cm",
                mascotHint: "4 + 5 + 6 = 15 cm.",
              },
            },
            {
              type: "summary",
        ...
        },
        {
          ...
          type: "learn",
          description: "Ôn lại ki-lô-gam, lít, đề-xi-mét, xăng-ti-mét",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "Đơn vị nào đo độ dài, đơn vị nào đo độ nặng, đơn vị nào đo sức chứa nhỉ? 📏",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Ôn Tập",
                title: "Ba loại đơn vị",
                explanation:
                  "Đo độ dài dùng cm, dm; đo khối lượng dùng kg; đo dung tích dùng l.",
                rule: "1 dm = 10 cm. Bút chì dài 15 cm. Túi gạo nặng 5 kg. Chai nước chứa 2 l.",
                points: [
                  "Đề-xi-mét là đơn vị đo độ dài lớn hơn xăng-ti-mét.",
                  "Đo độ dài thì dùng thước; đo khối lượng thì dùng cân; đo dung tích thì dùng ca đong.",
                  "Kết quả phép tính giữ nguyên đơn vị của bài toán.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                options: ["1 cm", "10 cm", "100 cm", "5 cm"],
                answer: "10 cm",
            ...
            },
            {
              ...
              content: {
                question:
                  "Sợi dây dài 2 dm. Sợi dây dài bao nhiêu xăng-ti-mét?",
                options: ["2 cm", "12 cm", "20 cm", "200 cm"],
                answer: "20 cm",
            ...
            },
            {
              ...
              content: {
                ...
                points: [
                  "1 dm = 10 cm.",
                  "cm, dm đo độ dài; kg đo khối lượng; l đo dung tích.",
                ],
                mascotMood: "celebrate",
              },
            },
        ...
        {
          id: "g2-c7-l5",
          title: "Bài 5: Ôn tập xem đồng hồ, xem lịch",
          type: "learn",
          description: "Ôn lại cách đọc giờ và đọc lịch",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Đồng hồ và tờ lịch là hai người bạn của bé mỗi ngày! 🕐",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Ôn Tập",
                title: "Đọc giờ và đọc lịch",
                explanation:
                  "Đọc giờ: kim ngắn là giờ, kim dài là phút. Đọc lịch: cùng một cột là cùng một thứ.",
                rule: "Kim ngắn số 4, kim dài số 6: 4 giờ 30 phút. Một năm có 12 tháng.",
                points: [
                  "1 ngày = 24 giờ; 1 giờ = 60 phút; 1 tuần = 7 ngày.",
                  "Tháng 31 ngày: 1, 3, 5, 7, 8, 10, 12.",
                  "19 giờ = 7 giờ tối.",
            ...
            },
            {
              ...
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "1 tuần = 7 ngày; 1 ngày = 24 giờ; 1 giờ = 60 phút.",
        ...
        },
        {
          ...
          type: "learn",
          description: "Ôn tập tổng hợp toàn bộ học kì 1",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "excited",
                text: "Bé đã đi hết nửa chặng đường của Lớp 2 rồi! Mình kiểm tra lại nhé 🎉",
              },
            },
            {
              type: "concept",
              content: {
                ...
                explanation:
                  "Bé đã học: số đến 100, cộng trừ trong phạm vi 20 và 100, ki-lô-gam, lít, các hình phẳng và xem đồng hồ, xem lịch.",
                points: [
                  "Cộng trừ: nhớ khi cần, mượn khi cần.",
                  "Đo lường: cm, dm, kg, l.",
                  "Hình học: đoạn thẳng, đường gấp khúc, tứ giác.",
                  "Thời gian: xem giờ, xem lịch.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                question:
                  "Bé có 45 viên bi, bé cho bạn 18 viên. Bé còn lại bao nhiêu viên bi?",
                options: [27, 37, 63, 17],
                answer: 27,
                mascotHint:
                  "45 − 18 = 27 viên bi (15 − 8 = 7; 4 bớt 1 còn 3, 3 − 1 = 2).",
              },
            },
            {
              type: "quiz",
              content: {
                question:
                  "Một sợi dây dài 3 dm. Sợi dây dài bao nhiêu xăng-ti-mét?",
                options: ["3 cm", "13 cm", "30 cm", "300 cm"],
                answer: "30 cm",
    ...
    // ═══ CHỦ ĐỀ 8 — SGK Bài 37-45 ═══
    {
      id: "g2-c8",
      name: "Chủ đề 8: Phép nhân, phép chia",
      description:
        "Phép nhân, thừa số và tích, bảng nhân 2, bảng nhân 5, phép chia, số bị chia - số chia - thương, bảng chia 2, bảng chia 5",
      icon: "✖️",
      color: "#e76f51",
      totalLessons: 16,
      lessons: [
        {
          ...
          type: "learn",
          description:
            "Nhận biết phép nhân là cách viết gọn của tổng các số hạng bằng nhau",
          slides: [
            {
              type: "story",
              content: {
            ...
            },
            {
              ...
              content: {
                question:
                  "Mỗi đĩa có 5 cái bánh, có 2 đĩa. Viết gọn thành phép nhân nào?",
                options: ["5 + 2", "5 × 2", "2 × 2", "5 × 5"],
                answer: "5 × 2",
        ...
        },
        {
          ...
          type: "learn",
          description:
            "Chuyển tổng các số hạng bằng nhau thành phép nhân và ngược lại",
          slides: [
            {
              type: "story",
              content: {
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Muốn viết tổng thành phép nhân, ta làm hai bước: đếm số hạng lặp lại, rồi lấy số hạng nhân với số lần lặp.",
                ...
                steps: [
                  ...
                  { title: "Bước 3", desc: "Viết phép nhân: 4 × 3 = 12." },
                ],
              },
            },
            {
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Trong phép nhân, hai số được nhân với nhau gọi là THỪA SỐ. Kết quả gọi là TÍCH.",
            ...
            },
            {
              ...
              content: {
                question:
                  "Trong phép nhân 6 × 2 = 12, các THỪA SỐ là những số nào?",
                options: ["6 và 2", "12", "6 và 12", "2 và 12"],
                answer: "6 và 2",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Bảng nhân 2 được lập bằng cách đếm thêm 2 mỗi bước: từ 2, cộng thêm 2 được 4, cộng thêm 2 được 6...",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Cách học dễ nhất: lấy kết quả của 2 × 5 = 10 rồi đếm thêm 2 cho mỗi bước tiếp theo.",
        ...
        },
        {
          ...
          type: "learn",
          description:
            "Vận dụng bảng nhân 2 vào tìm thừa số, tích và giải toán",
          slides: [
            {
              type: "story",
              content: {
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Bảng nhân 2 xuất hiện trong ba dạng bài: tính tích, tìm thừa số còn thiếu, và giải toán có lời văn.",
                points: [
                  "Tính tích: 2 × 7 = 14.",
            ...
            },
            {
              ...
              content: {
                question:
                  "Một con cua có 2 cái càng. Hỏi 5 con cua có bao nhiêu cái càng?",
                options: [7, 10, 12, 25],
                answer: 10,
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Bảng nhân 5 cũng lập bằng cách đếm thêm 5: từ 5, thêm 5 được 10, thêm 5 được 15...",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Lấy 5 × 5 = 25 rồi đếm thêm 5 cho mỗi bước tiếp theo.",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Cùng một số lượng đồ vật, đếm theo hàng hay theo cột đều ra kết quả như nhau.",
            ...
            },
            {
              ...
              content: {
                ...
                mascotHint:
                  "Đổi chỗ hai thừa số, tích không đổi: cả hai đều bằng 10.",
              },
            },
            {
              type: "quiz",
              content: {
                question:
                  "Một con chim có 2 cánh. Hỏi 5 con chim có bao nhiêu cánh?",
                options: [7, 10, 12, 25],
                answer: 10,
        ...
        },
        {
          ...
          type: "learn",
          description:
            "Nhận biết phép chia qua chia đều thành các phần bằng nhau",
          slides: [
            {
              type: "story",
              content: {
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Chia một số đồ vật thành các phần BẰNG NHAU thì ta dùng phép chia.",
            ...
            },
            {
              ...
              content: {
                question:
                  "Có 6 cái kẹo chia đều cho 2 bạn. Mỗi bạn được mấy cái kẹo?",
                options: [2, 3, 4, 6],
                answer: 3,
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Số đem đi chia gọi là SỐ BỊ CHIA. Số chia dùng để chia gọi là SỐ CHIA. Kết quả gọi là THƯƠNG.",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Lấy tích chia cho thừa số thứ nhất thì được thừa số thứ hai, và ngược lại.",
            ...
            },
            {
              ...
              content: {
                ...
                mascotHint:
                  "Lấy tích 15 chia cho từng thừa số: 15 : 5 = 3 và 15 : 3 = 5.",
              },
            },
            {
              type: "summary",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Lấy tích chia cho 2, ta được thừa số còn lại. Bảng nhân 2 và bảng chia 2 đi thành từng cặp.",
            ...
            },
            {
              ...
              content: {
                question:
                  "Có 16 quả táo chia đều vào 2 đĩa. Mỗi đĩa có mấy quả?",
                options: [7, 8, 9, 14],
                answer: 8,
        ...
        },
        {
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                question:
                  "Bạn Nam cắt 30 hình tròn, mỗi chiếc đèn cần 5 hình. Nam làm được mấy chiếc đèn?",
                options: [5, 6, 7, 25],
                answer: 6,
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Bé đã có trong tay bảng nhân 2, bảng nhân 5, bảng chia 2 và bảng chia 5. Giờ là lúc dùng chúng.",
                points: [
            ...
            },
            {
              ...
              content: {
                question:
                  "Có 35 bạn đi cắm trại, cô giáo chia đều thành 5 nhóm. Mỗi nhóm có mấy bạn?",
                options: [5, 6, 7, 30],
                answer: 7,
            ...
            },
            {
              ...
              content: {
                question:
                  "Bà có 20 quả vải, bà chia đều cho 2 cháu. Mỗi cháu được mấy quả?",
                options: [5, 10, 18, 22],
                answer: 10,
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Đặt các tấm thẻ ghi phép tính trên bàn. Gieo xúc xắc được mấy chấm thì úp tấm thẻ có KẾT QUẢ bằng số chấm đó.",
                points: [
            ...
            },
            {
              ...
              content: {
                question:
                  "Xúc xắc gieo được 8 chấm. Phép tính nào cho kết quả bằng 8?",
                options: ["16 : 2", "5 × 5", "20 : 5", "2 × 5"],
                answer: "16 : 2",
            ...
            },
            {
              ...
              content: {
                question:
                  "Xúc xắc gieo được 6 chấm. Bé chọn được mấy phép tính đúng? 2 × 3 · 12 : 2 · 30 : 5 · 5 + 1",
                options: [
                  "1 phép tính",
                  "2 phép tính",
                  "3 phép tính",
                ...
                answer: "3 phép tính",
                mascotHint:
                  "2 × 3 = 6, 12 : 2 = 6 và 30 : 5 = 6 — cả ba đều bằng 6. Riêng 5 + 1 = 6 là phép CỘNG, không phải nhân hay chia.",
              },
            },
            {
              type: "summary",
    ...
    // ═══ CHỦ ĐỀ 9 — SGK Bài 46-47 ═══
    {
      id: "g2-c9",
      name: "Chủ đề 9: Làm quen với hình khối",
      description:
        "Khối trụ, khối cầu và nhận biết các vật có dạng khối trụ, khối cầu",
      icon: "🥫",
      color: "#6a994e",
      totalLessons: 4,
      lessons: [
        {
          id: "g2-c9-l1",
          title: "Bài 1: Khối trụ",
          type: "learn",
          description: "Nhận biết khối trụ và các vật có dạng khối trụ",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "Lon sữa, hộp quà, cây nến đều có dạng giống nhau. Đó là khối gì nhỉ? 🥫",
              },
            },
            {
              type: "concept",
              content: {
                ...
                title: "Khối trụ",
                explanation:
                  "KHỐI TRỤ có hai mặt phẳng giống hình tròn ở hai đầu và thân tròn cong đều.",
                rule: "Lon sữa, hộp quà hình trụ, cây nến, ống nhựa đều có dạng khối trụ.",
                points: [
                  "Khối trụ đặt đứng được, đặt nằm được.",
                  "Đặt nằm thì khối trụ lăn được theo một hướng.",
                  "Hai mặt hai đầu là hai hình tròn bằng nhau.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                options: ["Lon sữa", "Quả bóng", "Viên bi", "Quyển sách"],
                answer: "Lon sữa",
                mascotHint:
                  "Lon sữa có hai mặt tròn và thân cong đều — đó là khối trụ.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Khối trụ có hai mặt tròn ở hai đầu.",
                  "Lon sữa, hộp quà, cây nến có dạng khối trụ.",
                ],
                mascotMood: "proud",
              },
            },
        ...
        {
          id: "g2-c9-l2",
          title: "Bài 2: Khối cầu",
          type: "learn",
          description: "Nhận biết khối cầu và các vật có dạng khối cầu",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "excited",
                text: "Quả bóng lăn được mọi hướng! Vì sao nhỉ? ⚽",
              },
            },
            {
              type: "concept",
              content: {
                ...
                title: "Khối cầu",
                explanation:
                  "KHỐI CẦU tròn đều như quả bóng. Khối cầu không có mặt phẳng nào cả.",
                rule: "Quả bóng, viên bi, quả địa cầu đều có dạng khối cầu.",
                points: [
                  "Khối cầu lăn được theo MỌI hướng.",
                  "Khối cầu không xếp chồng lên nhau được vì sẽ bị lăn.",
            ...
            },
            {
              type: "quiz",
              content: {
                question: "Vật nào lăn được theo MỌI hướng?",
                options: ["Quả bóng", "Lon sữa đặt nằm", "Hộp quà", "Cây nến"],
                answer: "Quả bóng",
                mascotHint: "Quả bóng là khối cầu nên lăn được mọi hướng.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Khối cầu tròn đều, lăn được mọi hướng.",
        ...
        {
          id: "g2-c9-l3",
          title: "Bài 3: So sánh khối trụ và khối cầu",
          type: "learn",
          description:
            "Phân biệt khối trụ với khối cầu qua khả năng lăn và xếp chồng",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Bé thử xếp chồng các lon sữa và quả bóng xem cái nào xếp được nhé! 🧱",
              },
            },
            {
              type: "concept",
              content: {
                ...
                explanation:
                  "Khối trụ có hai mặt phẳng nên đặt đứng và xếp chồng được. Khối cầu tròn đều nên chỉ lăn, không xếp chồng được.",
                ...
                points: [
                  ...
                  "Trong đời sống, thùng phi, hộp sữa là khối trụ; quả bóng, viên bi là khối cầu.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                answer: "Khối trụ",
                mascotHint: "Khối trụ có hai mặt phẳng nên xếp chồng được.",
              },
            },
            {
              type: "summary",
              content: {
                ...
                points: [
                  ...
                  "Khối cầu lăn mọi hướng; khối trụ đặt nằm chỉ lăn một hướng.",
                ],
                mascotMood: "celebrate",
              },
            },
        ...
        {
          id: "g2-c9-l4",
          title: "Bài 4: Luyện tập chung chủ đề 9",
          type: "learn",
          description: "Ôn tập khối trụ và khối cầu",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "excited",
                text: "Rô-bốt bày một đống đồ chơi. Bé phân loại giúp Rô-bốt nhé! 🧸",
              },
            },
            {
              type: "concept",
              content: {
                ...
                explanation:
                  "Bé đã học khối trụ và khối cầu. Chú ý hai đặc điểm: lăn được hướng nào và có xếp chồng được hay không.",
                points: [
                  "Khối trụ: hai mặt tròn, xếp chồng được, đặt nằm thì lăn một hướng.",
                  "Khối cầu: tròn đều, lăn mọi hướng, không xếp chồng được.",
                  "Nhìn đồ vật quanh em: hộp sữa là khối trụ, quả bóng là khối cầu.",
                ],
              },
            },
            {
            ...
            },
            {
              type: "quiz",
              content: {
                question: "Hộp sữa và quả bóng — vật nào có dạng khối trụ?",
                options: ["Hộp sữa", "Quả bóng", "Cả hai", "Không vật nào"],
                answer: "Hộp sữa",
                mascotHint: "Hộp sữa là khối trụ, quả bóng là khối cầu.",
              },
            },
            {
              type: "summary",
    ...
    // ═══ CHỦ ĐỀ 10 — SGK Bài 48-54 ═══
    {
      id: "g2-c10",
      name: "Chủ đề 10: Các số trong phạm vi 1 000",
      description:
        "Đơn vị, chục, trăm, nghìn; các số tròn trăm, tròn chục; số có ba chữ số; so sánh và viết số thành tổng",
      icon: "💯",
      color: "#4361ee",
      totalLessons: 11,
      lessons: [
        {
          ...
          type: "learn",
          description: "Nhận biết quan hệ giữa đơn vị, chục và trăm",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "10 que tính rời gộp lại thành một bó. Vậy 10 đơn vị bằng gì nhỉ? 🧮",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Khám Phá",
                title: "10 đơn vị = 1 chục, 10 chục = 1 trăm",
                explanation:
                  "Cứ 10 đơn vị gộp lại thành 1 chục; cứ 10 chục gộp lại thành 1 trăm.",
                rule: "10 đơn vị = 1 chục. 10 chục = 1 trăm. 1 trăm = 100.",
                points: [
                  "1 chục = 10 đơn vị.",
                  "1 trăm = 10 chục = 100 đơn vị.",
                  "Que tính bó thành bó 10 que là cách dễ thấy nhất.",
                ],
              },
            },
            {
            ...
            },
            {
              type: "quiz",
              content: {
                question: "1 chục gồm mấy đơn vị?",
                options: [1, 10, 100, 5],
                answer: 10,
        ...
        {
          id: "g2-c10-l2",
          title: "Bài 2: Nghìn và số 1000",
          type: "learn",
          description: "Nhận biết 10 trăm bằng 1 nghìn và số 1000",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "excited",
                text: "10 tấm bìa trăm xếp lại thì được gì nhỉ? Rô-bốt vừa phát hiện một số mới! 🎉",
              },
            },
            {
              type: "concept",
              content: {
                ...
                title: "Một nghìn",
                explanation:
                  "10 trăm gộp lại thành 1 NGHÌN. Số một nghìn được viết là 1000.",
                rule: "10 trăm = 1 nghìn = 1000. Đọc là: một nghìn.",
                points: [
                  "1000 gồm bốn chữ số: 1 rồi ba chữ số 0.",
                  "1000 là số tròn nghìn đầu tiên.",
                  "Số liền trước của 1000 là 999; số liền sau của 999 là 1000.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                options: [100, 1000, 10000, 20],
                answer: 1000,
                mascotHint: "10 trăm = 1 nghìn = 1000.",
              },
            },
            {
              type: "quiz",
              content: {
                question: "Số liền sau của 999 là số nào?",
                options: [998, 1000, 1001, 9999],
                answer: 1000,
                mascotHint: "999 thêm 1 được 1000.",
              },
            },
            {
              type: "summary",
        ...
        {
          id: "g2-c10-l3",
          title: "Bài 3: Các số tròn trăm",
          type: "learn",
          description: "Đọc, viết và nhận biết các số tròn trăm",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Các số 100, 200, 300... có gì đặc biệt nhỉ? Bé nhìn chữ số 0 xem! 💯",
              },
            },
            {
              type: "concept",
              content: {
                ...
                title: "Số tròn trăm",
                explanation:
                  "Số TRÒN TRĂM là số có hàng chục và hàng đơn vị đều là 0, chỉ có hàng trăm khác 0.",
                rule: "Các số tròn trăm: 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000.",
                points: [
                  "Mỗi số tròn trăm hơn kém nhau đúng 100.",
                  "200 gồm 2 trăm, 0 chục, 0 đơn vị.",
                  "Đọc: 500 là năm trăm, 800 là tám trăm.",
                ],
              },
            },
            {
            ...
            },
            {
              type: "quiz",
              content: {
                question: "Số nào dưới đây là số tròn trăm?",
                options: [305, 400, 410, 140],
                answer: 400,
                mascotHint: "400 có hàng chục và hàng đơn vị đều là 0.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Số tròn trăm có hai chữ số 0 ở cuối (trừ 1000).",
        ...
        {
          id: "g2-c10-l4",
          title: "Bài 4: Các số tròn chục",
          type: "learn",
          description: "Đọc, viết và nhận biết các số tròn chục",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Số 250 có gì đặc biệt? Chữ số hàng đơn vị của nó là 0 đấy! 📘",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Khám Phá",
                title: "Số tròn chục",
                explanation: "Số TRÒN CHỤC là số có hàng đơn vị bằng 0.",
                rule: "Các số tròn chục: 10, 20, 30, ..., 100, 110, 120, ..., 990, 1000.",
                points: [
                  "Số tròn chục luôn tận cùng bằng chữ số 0.",
                  "250 là số tròn chục: 2 trăm, 5 chục, 0 đơn vị.",
                  "Mọi số tròn trăm cũng là số tròn chục.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                options: [205, 250, 255, 512],
                answer: 250,
                mascotHint: "250 có hàng đơn vị là 0 nên là số tròn chục.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Số tròn chục tận cùng bằng chữ số 0.",
                  "10, 20, 30, ..., 990, 1000.",
                ],
                mascotMood: "proud",
              },
        ...
        {
          id: "g2-c10-l5",
          title: "Bài 5: So sánh các số tròn trăm, tròn chục",
          type: "learn",
          description:
            "So sánh các số tròn trăm và tròn chục theo hàng trăm, hàng chục",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "300 và 500, số nào lớn hơn? Nhìn hàng trăm là biết ngay! 🔍",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Mẹo Nhớ",
                title: "So hàng trăm trước",
                explanation:
                  "Với các số tròn trăm, số nào có chữ số hàng trăm lớn hơn thì lớn hơn. Với số tròn chục, so hàng trăm rồi đến hàng chục.",
                rule: "300 < 500 vì 3 < 5. 240 < 260 vì hàng chục 4 < 6.",
                points: [
                  "So hàng trăm trước; bằng nhau thì mới so tiếp.",
                  "200 < 700; 900 > 600.",
                  "250 > 240 vì 5 chục > 4 chục.",
                ],
              },
            },
            {
            ...
            },
            {
              type: "quiz",
              content: {
                question: "Trong hai số 600 và 400, số nào lớn hơn?",
                options: [600, 400, "Hai số bằng nhau"],
                answer: 600,
                mascotHint: "6 trăm > 4 trăm nên 600 > 400.",
              },
            },
            {
              type: "quiz",
              content: {
                question: "Trong hai số 250 và 280, số nào bé hơn?",
                options: [250, 280, "Hai số bằng nhau"],
                answer: 250,
                mascotHint:
                  "Hàng trăm bằng nhau, so hàng chục: 5 < 8 nên 250 < 280.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "So hàng trăm trước, rồi đến hàng chục.",
                  "300 < 500; 250 < 280.",
                ],
                mascotMood: "proud",
              },
        ...
        {
          id: "g2-c10-l6",
          title: "Bài 6: Số có ba chữ số",
          type: "learn",
          description:
            "Nhận biết cấu tạo số có ba chữ số gồm trăm, chục, đơn vị",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "Số 245 có tới ba chữ số. Mỗi chữ số nói lên điều gì nhỉ? 🔢",
              },
            },
            {
              type: "concept",
              content: {
                ...
                explanation:
                  "Một số có ba chữ số gồm HÀNG TRĂM, HÀNG CHỤC và HÀNG ĐƠN VỊ.",
                rule: "Số 245 gồm 2 trăm, 4 chục và 5 đơn vị. Đọc là: hai trăm bốn mươi lăm.",
                points: [
                  "Chữ số thứ nhất từ trái sang là hàng trăm.",
                  "Chữ số thứ hai là hàng chục, chữ số thứ ba là hàng đơn vị.",
            ...
            },
            {
              type: "quiz",
              content: {
                question: "Số 376 gồm mấy trăm, mấy chục, mấy đơn vị?",
                options: [
                  "3 trăm, 7 chục, 6 đơn vị",
                  "6 trăm, 7 chục, 3 đơn vị",
                  "3 trăm, 6 chục, 7 đơn vị",
                  "37 chục, 6 đơn vị",
                ],
                answer: "3 trăm, 7 chục, 6 đơn vị",
                mascotHint:
                  "Đọc từ trái sang: 3 là trăm, 7 là chục, 6 là đơn vị.",
              },
            },
            {
              type: "summary",
              content: {
                ...
                points: [
                  ...
                  "245 gồm 2 trăm, 4 chục, 5 đơn vị.",
                ],
                mascotMood: "proud",
              },
            },
        ...
        {
          id: "g2-c10-l7",
          title: "Bài 7: Đọc và viết số có ba chữ số",
          type: "learn",
          description: "Đọc, viết số có ba chữ số kể cả số có chữ số 0",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Số 405 đọc thế nào nhỉ? Có chữ số 0 ở giữa đấy! ✏️",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Mẹo Nhớ",
                title: "Cách đọc số có ba chữ số",
                explanation:
                  "Đọc hàng trăm, rồi đến hàng chục, rồi hàng đơn vị. Khi hàng chục là 0 thì đọc là 'linh'.",
                rule: "405 đọc là: bốn trăm linh năm. 450 đọc là: bốn trăm năm mươi.",
                points: [
                  "Chữ số 0 ở hàng chục thì đọc 'linh'.",
                  "Chữ số 0 ở hàng đơn vị thì không đọc.",
                  "520 đọc là năm trăm hai mươi.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                answer: "Bốn trăm linh năm",
                mascotHint: "Hàng chục là 0 nên đọc 'linh': bốn trăm linh năm.",
              },
            },
            {
              type: "quiz",
              content: {
                question: "Số 'sáu trăm ba mươi' được viết thế nào?",
                options: [603, 630, 63, 6030],
                answer: 630,
                mascotHint: "Sáu trăm (6) ba mươi (3 chục, 0 đơn vị) → 630.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Hàng chục bằng 0 thì đọc 'linh'.",
                  "405 đọc là bốn trăm linh năm; 630 viết là 630.",
                ],
                mascotMood: "celebrate",
              },
            },
        ...
        {
          id: "g2-c10-l8",
          title: "Bài 8: Viết số thành tổng các trăm, chục, đơn vị",
          type: "learn",
          description: "Phân tích số có ba chữ số thành tổng",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Số 245 có thể viết thành phép cộng được đấy! Bé xem nhé 🧩",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Mẹo Nhớ",
                title: "Tách số thành tổng",
                explanation:
                  "Lấy chữ số hàng trăm nhân với 100, chữ số hàng chục nhân với 10, rồi cộng với chữ số hàng đơn vị.",
                rule: "245 = 200 + 40 + 5. 405 = 400 + 5 (vì 0 chục nên không cần viết).",
                points: [
                  "Hàng trăm nhân 100, hàng chục nhân 10.",
                  "Chữ số hàng đơn vị giữ nguyên.",
                  "Nếu chữ số nào là 0 thì bỏ phần đó đi.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                options: ["300 + 70 + 6", "300 + 76", "30 + 76", "3 + 7 + 6"],
                answer: "300 + 70 + 6",
                mascotHint: "3 trăm là 300, 7 chục là 70, 6 đơn vị là 6.",
              },
            },
            {
              type: "quiz",
              content: {
                question: "Số 500 + 40 + 2 bằng bao nhiêu?",
                options: [542, 524, 500402, 5420],
                answer: 542,
                mascotHint: "500 + 40 + 2 = 542.",
              },
            },
            {
              type: "summary",
              content: {
                ...
                points: [
                  "245 = 200 + 40 + 5.",
                  "Chữ số 0 thì bỏ phần đó: 405 = 400 + 5.",
                ],
                mascotMood: "proud",
              },
            },
        ...
        {
          id: "g2-c10-l9",
          title: "Bài 9: So sánh các số có ba chữ số",
          type: "learn",
          description: "So sánh hai số có ba chữ số theo từng hàng",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "245 và 254, số nào lớn hơn? Hai số này nhìn giống nhau quá! 🤔",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Mẹo Nhớ",
                title: "So lần lượt từng hàng",
                explanation:
                  "So hàng trăm trước. Bằng nhau thì so hàng chục. Bằng nhau nữa thì so hàng đơn vị.",
                rule: "245 và 254: hàng trăm đều là 2, so hàng chục 4 < 5. Vậy 245 < 254.",
                points: [
                  "Chỉ so tiếp khi hàng trước bằng nhau.",
                  "376 > 299 vì 3 trăm > 2 trăm.",
                  "Số có nhiều chữ số hơn thì lớn hơn: 1000 > 999.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                options: [245, 254, "Hai số bằng nhau"],
                answer: 254,
                mascotHint:
                  "Hàng trăm bằng nhau, so hàng chục: 4 < 5 nên 245 < 254.",
              },
            },
            {
              type: "quiz",
              content: {
                question: "Trong hai số 376 và 299, số nào lớn hơn?",
                options: [376, 299, "Hai số bằng nhau"],
                answer: 376,
                mascotHint: "3 trăm > 2 trăm nên 376 > 299, không cần so tiếp.",
              },
            },
            {
              type: "summary",
        ...
        {
          id: "g2-c10-l10",
          title: "Bài 10: Thứ tự các số có ba chữ số",
          type: "learn",
          description: "Sắp xếp các số có ba chữ số theo thứ tự",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "excited",
                text: "Bé giúp Rô-bốt xếp hàng các con số từ bé đến lớn nhé! 📊",
              },
            },
            {
              type: "concept",
              content: {
                ...
                explanation:
                  "Muốn xếp từ bé đến lớn, bé tìm số bé nhất trước rồi lần lượt các số tiếp theo. Muốn xếp từ lớn đến bé thì làm ngược lại.",
                rule: "Xếp 245, 254, 199 từ bé đến lớn: 199, 245, 254. Từ lớn đến bé: 254, 245, 199.",
                points: [
                  "So từng cặp số để tìm số bé nhất.",
                  "199 bé nhất vì 1 trăm bé hơn 2 trăm.",
                  "Số liền trước, liền sau vẫn đúng với số có ba chữ số.",
                ],
              },
            },
            {
              ...
              content: {
                ...
                numberLine: {
                  ...
                  marks: [199, 245, 254],
                  label:
                    "Bé đến lớn: 199 · 245 · 254 — lớn đến bé: 254 · 245 · 199",
                },
              },
            },
            {
              ...
              content: {
                question:
                  "Sắp xếp ba số 320, 302, 298 theo thứ tự từ bé đến lớn:",
                options: [
                  "298, 302, 320",
                  "320, 302, 298",
                  "302, 298, 320",
            ...
            },
            {
              ...
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Sắp xếp thì so từng cặp số với nhau.",
                  "298 < 302 < 320.",
                ],
                mascotMood: "celebrate",
              },
        ...
        {
          id: "g2-c10-l11",
          title: "Bài 11: Luyện tập chung chủ đề 10",
          type: "learn",
          description: "Ôn tập các số trong phạm vi 1 000",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Bé đã đi hết các số đến 1 000 rồi! Tổng kết nhé 🎉",
              },
            },
            {
              type: "concept",
              content: {
                ...
                explanation:
                  "Bé đã học đơn vị, chục, trăm, nghìn; các số tròn trăm, tròn chục; số có ba chữ số và cách so sánh.",
                points: [
            ...
            },
            {
              type: "quiz",
              content: {
                question: "Số nào lớn nhất trong các số: 909, 990, 899, 1000?",
                options: [909, 990, 899, 1000],
                answer: 1000,
                mascotHint: "1000 là số lớn nhất trong bốn số.",
              },
            },
            {
              type: "quiz",
              content: {
                question: "Số 708 viết thành tổng nào?",
                options: ["700 + 8", "700 + 80 + 8", "70 + 8", "7 + 0 + 8"],
                answer: "700 + 8",
                mascotHint: "708 gồm 7 trăm, 0 chục, 8 đơn vị → 700 + 8.",
              },
            },
            {
              type: "summary",
    ...
    // ═══ CHỦ ĐỀ 11 — SGK Bài 55-58 ═══
    {
      id: "g2-c11",
      name: "Chủ đề 11: Độ dài và đơn vị đo độ dài. Tiền Việt Nam",
      description:
        "Đề-xi-mét, mét, ki-lô-mét; giới thiệu tiền Việt Nam; thực hành đo độ dài",
      icon: "📏",
      color: "#ef476f",
      totalLessons: 7,
      lessons: [
        {
          id: "g2-c11-l1",
          title: "Bài 1: Đề-xi-mét (dm)",
          type: "learn",
          description: "Nhận biết đề-xi-mét và quan hệ với xăng-ti-mét",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "Bút chì dài 15 cm, còn quyển sách dài 2 dm. Vậy 1 dm bằng bao nhiêu cm nhỉ? 📏",
              },
            },
            {
              type: "concept",
              content: {
                ...
                title: "Đề-xi-mét",
                explanation:
                  "ĐỀ-XI-MÉT là đơn vị đo độ dài lớn hơn xăng-ti-mét. Viết tắt là dm.",
                rule: "1 dm = 10 cm. Quyển sách dài 2 dm nghĩa là dài 20 cm.",
                points: [
                  "Đổi dm sang cm: lấy số dm nhân với 10.",
                  "Đổi cm sang dm: lấy số cm chia cho 10.",
                  "dm dùng để đo những vật vừa vừa như quyển sách, gang tay.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                title: "Bé nhớ rất tốt:",
                points: ["1 dm = 10 cm.", "Đổi dm sang cm thì nhân với 10."],
                mascotMood: "proud",
              },
            },
          ],
        },
        {
          ...
          title: "Bài 2: Mét (m)",
          type: "learn",
          description: "Nhận biết mét và quan hệ với đề-xi-mét, xăng-ti-mét",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Chiều cao của Rô-bốt là 1 m. Bé cao bao nhiêu mét nhỉ? 📐",
              },
            },
            {
              type: "concept",
              content: {
                ...
                title: "Mét",
                explanation:
                  "MÉT là đơn vị đo độ dài lớn hơn đề-xi-mét. Viết tắt là m.",
                rule: "1 m = 10 dm = 100 cm. Chiều cao của bé khoảng 1 m đến 1 m 30 cm.",
                points: [
                  "1 m = 100 cm, nên 2 m = 200 cm.",
                  "Mét dùng để đo chiều cao, chiều dài phòng học, chiều dài sân.",
                  "100 cm = 10 dm = 1 m.",
                ],
              },
            },
            ...
            },
            {
              ...
              content: {
                ...
                options: ["10 cm", "100 cm", "1000 cm", "20 cm"],
                answer: "100 cm",
            ...
            },
            {
              ...
              content: {
                ...
                options: ["1 dm", "10 dm", "100 dm", "1000 dm"],
                answer: "10 dm",
                mascotHint: "1 m = 10 dm.",
              },
            },
            {
              type: "summary",
              content: {
                ...
                points: [
                  "1 m = 10 dm = 100 cm.",
                  "Mét dùng để đo chiều cao, chiều dài phòng học.",
                ],
                mascotMood: "proud",
              },
            },
        ...
        {
          id: "g2-c11-l3",
          title: "Bài 3: Ki-lô-mét (km)",
          type: "learn",
          description: "Nhận biết ki-lô-mét dùng để đo quãng đường dài",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "excited",
                text: "Từ nhà bé đến trường dài 2 km. Vậy 1 km bằng bao nhiêu mét nhỉ? 🚌",
              },
            },
            {
              type: "concept",
              content: {
                ...
                title: "Ki-lô-mét",
                explanation:
                  "KI-LÔ-MÉT là đơn vị đo độ dài lớn nhất bé đã học. Viết tắt là km.",
                rule: "1 km = 1000 m. Quãng đường dài 2 km nghĩa là dài 2000 m.",
                points: [
                  "km dùng để đo quãng đường giữa các địa điểm.",
                  "1 km = 1000 m, nên 3 km = 3000 m.",
                  "1000 m = 1 km.",
                ],
              },
            },
        ...
        {
          id: "g2-c11-l4",
          title: "Bài 4: Giới thiệu tiền Việt Nam",
          type: "learn",
          description: "Nhận biết các tờ tiền Việt Nam và mệnh giá",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Mẹ cho Rô-bốt một tờ tiền để đi mua bánh. Bé xem đó là tờ bao nhiêu nhé! 💵",
              },
            },
            {
              type: "concept",
              content: {
                ...
                title: "Tiền Việt Nam",
                explanation:
                  "Tiền Việt Nam gồm nhiều tờ với mệnh giá khác nhau. Mệnh giá là số tiền ghi trên tờ tiền.",
                rule: "Các tờ tiền thường gặp: 100 đồng, 200 đồng, 500 đồng, 1000 đồng, 2000 đồng, 5000 đồng.",
                points: [
                  "Đơn vị tiền của Việt Nam là ĐỒNG.",
                  "Tờ 1000 đồng có giá trị bằng hai tờ 500 đồng.",
                  "Hai tờ 2000 đồng có giá trị bằng một tờ 5000 đồng? Không — phải thêm 1000 đồng nữa.",
                ],
              },
            },
            {
            ...
            },
            {
              ...
              content: {
                ...
                options: ["Đồng", "Đô la", "Yên", "Euro"],
                answer: "Đồng",
                mascotHint: "Tiền Việt Nam tính bằng đồng.",
              },
            },
            {
              type: "quiz",
              content: {
                question: "Một tờ 1000 đồng có giá trị bằng mấy tờ 500 đồng?",
                options: ["1 tờ", "2 tờ", "5 tờ", "10 tờ"],
                answer: "2 tờ",
                mascotHint: "500 + 500 = 1000, nên cần 2 tờ 500 đồng.",
              },
            },
            {
              type: "summary",
              content: {
                ...
                points: [
                  ...
                  "Các tờ thường gặp: 100, 200, 500, 1000, 2000, 5000 đồng.",
                ],
                mascotMood: "proud",
              },
            },
        ...
        {
          id: "g2-c11-l5",
          title: "Bài 5: Đổi tiền và tính tiền",
          type: "learn",
          description: "Đổi các tờ tiền và tính tiền mua hàng",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "curious",
                text: "Rô-bốt có 2000 đồng, mua bánh hết 1500 đồng. Còn lại bao nhiêu nhỉ? 🍪",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Thực Hành",
                title: "Cộng và trừ tiền",
                explanation:
                  "Muốn biết có tất cả bao nhiêu tiền, ta CỘNG các tờ lại. Muốn biết còn lại bao nhiêu, ta TRỪ đi số đã tiêu.",
                rule: "1000 đồng + 500 đồng = 1500 đồng. 2000 đồng − 1500 đồng = 500 đồng.",
                points: [
                  "Cộng tiền khi gom các tờ lại.",
                  "Trừ tiền khi mua hàng để biết tiền thừa.",
                  "Nhớ ghi đơn vị 'đồng' vào kết quả.",
                ],
              },
            },
            {
              ...
              content: {
                ...
                money: {
                  notes: [2000, 1000, 500],
                  label:
                    "Mua bánh 1500 đồng, trả 2000 đồng, tiền thừa 500 đồng",
                },
              },
            },
            {
              ...
              content: {
                question:
                  "Rô-bốt có 2000 đồng, mua bánh hết 1500 đồng. Hỏi còn lại bao nhiêu tiền?",
                options: ["300 đồng", "500 đồng", "1000 đồng", "3500 đồng"],
                answer: "500 đồng",
                mascotHint: "2000 − 1500 = 500 đồng.",
              },
            },
            {
              type: "quiz",
              content: {
                question:
                  "Bé có một tờ 2000 đồng và một tờ 1000 đồng. Bé có tất cả bao nhiêu tiền?",
                options: ["1000 đồng", "2000 đồng", "3000 đồng", "2100 đồng"],
                answer: "3000 đồng",
                mascotHint: "2000 + 1000 = 3000 đồng.",
              },
            },
            {
              type: "summary",
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Gom tiền thì cộng; mua hàng thì trừ.",
                  "2000 − 1500 = 500 đồng.",
                ],
                mascotMood: "celebrate",
              },
        ...
        {
          id: "g2-c11-l6",
          title: "Bài 6: Thực hành và trải nghiệm đo độ dài",
          type: "learn",
          description: "Ước lượng và đo độ dài bằng dm, m, km",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "excited",
                text: "Bé hãy ước lượng chiều dài bàn học rồi đo lại xem đoán có đúng không nhé! 📏",
              },
            },
            {
              type: "concept",
              content: {
                badge: "Thực Hành",
                title: "Chọn đơn vị đo phù hợp",
                explanation:
                  "Chọn đơn vị đo cho phù hợp với vật: vật nhỏ dùng cm, vật vừa dùng dm, phòng học dùng m, quãng đường dùng km.",
                rule: "Bút chì dài 15 cm. Bàn học dài 12 dm. Phòng học dài 8 m. Nhà đến trường 2 km.",
                points: [
                  "Ước lượng trước, đo sau để kiểm tra.",
                  "Chọn sai đơn vị thì số đo vô nghĩa: không ai nói bút chì dài 15 m.",
                  "1 m = 10 dm = 100 cm; 1 km = 1000 m.",
                ],
              },
            },
            {
            ...
            },
            {
              type: "quiz",
              content: {
                question: "Đo chiều dài phòng học thì nên dùng đơn vị nào?",
                options: [
                  "Mét (m)",
                  "Xăng-ti-mét (cm)",
                  "Mi-li-mét (mm)",
                ...
                answer: "Mét (m)",
                mascotHint: "Phòng học dài vài mét nên dùng mét.",
              },
            },
            {
              type: "quiz",
              content: {
                question:
                  "Quãng đường từ nhà đến trường nên đo bằng đơn vị nào?",
                options: [
                  "Ki-lô-mét (km)",
                  "Đề-xi-mét (dm)",
                  "Xăng-ti-mét (cm)",
            ...
            },
            {
              ...
              content: {
                ...
                points: [
                  ...
                  "cm, dm, m, km — đơn vị càng về sau càng lớn.",
                ],
                mascotMood: "proud",
              },
            },
        ...
        {
          id: "g2-c11-l7",
          title: "Bài 7: Luyện tập chung chủ đề 11",
          type: "learn",
          description: "Ôn tập đơn vị đo độ dài và tiền Việt Nam",
          slides: [
            {
              type: "story",
              content: {
                mascotMood: "happy",
                text: "Bé đã biết đo độ dài và biết dùng tiền rồi! Tổng kết nhé 🎉",
              },
            },
            {
              type: "concept",
              content: {
                ...
                explanation:
                  "Bé đã học đề-xi-mét, mét, ki-lô-mét và tiền Việt Nam.",
                points: [
                  "1 dm = 10 cm; 1 m = 10 dm = 100 cm; 1 km = 1000 m.",
                  "Đơn vị tiền Việt Nam là đồng.",
                  "Mua hàng thì trừ, gom tiền thì cộng.",
                ],
              },
            },
            {
            ...
            },
            {
              type: "quiz",
              content: {
                question: "5 m bằng bao nhiêu xăng-ti-mét?",
                options: ["50 cm", "500 cm", "5000 cm", "15 cm"],
                answer: "500 cm",
                mascotHint: "5 m = 5 × 100 = 500 cm.",
              },
            },
            {
              type: "quiz",
              content: {
                question:
                  "Bé mua vở hết 3000 đồng và bút hết 2000 đồng. Bé phải trả tất cả bao nhiêu?",
                options: ["1000 đồng", "5000 đồng", "6000 đồng", "500 đồng"],
                answer: "5000 đồng",
                mascotHint: "3000 + 2000 = 5000 đồng.",
              },
            },
            {
              type: "summary",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                title: "Bé nhớ rất tốt:",
                points: [
                  "Cộng từ hàng đơn vị sang hàng trăm.",
                  "235 + 412 = 647.",
                ],
                mascotMood: "proud",
              },
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Bài toán 'bán đi, cho đi, bớt đi' thì dùng phép trừ.",
            ...
            },
            {
              ...
              content: {
                ...
                table: {
                  ...
                  label:
                    "Hỏi từng bạn rồi xếp vào hai nhóm — mỗi bạn chỉ ở một nhóm",
                },
              },
            },
            {
              ...
              content: {
                ...
                mascotHint:
                  "Tiêu chí phải rõ và mọi quả phải thuộc đúng một nhóm.",
              },
            },
            {
              type: "summary",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                options: [3, 4, 5, 40],
                answer: 4,
                // Hình cho bé ĐẾM — câu hỏi nói "trên biểu đồ" mà trước đây không vẽ gì.
                // Emoji viết dạng mã hoá: ghi thẳng ký tự từng bị hỏng thành U+FFFD.
                items: [{ emoji: "\u{1F34A}", count: 4 }],
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                items: [
                  { emoji: "\u{1F34E}", count: 3 },
                  { emoji: "\u{1F34A}", count: 2 },
                ],
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                answer: "Không thể",
                mascotHint:
                  "Xúc xắc chỉ có 6 mặt, không bao giờ có mặt 7 chấm.",
              },
            },
            {
              type: "quiz",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Bé nhớ lại cấu tạo số có ba chữ số và cách so sánh.",
            ...
            },
            {
              ...
              content: {
                ...
                mascotHint:
                  "Đọc từ trái sang: 3 là trăm, 8 là chục, 6 là đơn vị.",
              },
            },
            {
              type: "summary",
          ...
          slides: [
            ...
            },
            {
              ...
              content: {
                ...
                explanation:
                  "Lớp 2 học bốn bảng: nhân 2, nhân 5, chia 2, chia 5.",
            ...
            },
            {
              ...
              content: {
                question:
                  "Có 18 cái kẹo chia đều cho 2 bạn. Mỗi bạn được mấy cái?",
                options: [6, 8, 9, 16],
                answer: 9,
