              ...
              rows: [
                {
                  ...
                  shaded: 15,
                  groups: 3,
                  label: "18 bạn: 6 nhóm, mỗi nhóm 3 bạn",
                },
                {
                  parts: 6,
                  shaded: 5,
                  label: "15/18 = 5/6 (chia cả hai cho 3)",
                },
              ],
              label:
                "Tỉ số của a và b là a : b hay a/b (b khác 0) — gộp 3 bạn thành 1 nhóm thì 18 bạn = 6 nhóm, 15 bạn = 5 nhóm",
            },
          },
        },
        {
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          type: "visual",
          content: {
            text: "Tìm hai số khi biết Tổng và Tỉ số",
            table: {
              headers: ["Bước", "Làm"],
              rows: [
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          type: "visual",
          content: {
            text: "Tìm hai số khi biết Hiệu và Tỉ số",
            table: {
              headers: ["Bước", "Làm"],
              rows: [
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          type: "visual",
          content: {
            text: "2 cm trên bản đồ tỉ lệ 1 : 1 000 ứng với 2 000 cm = 20 m thật",
            ruler: {
              lengthCm: 2,
              measure: {
                from: 0,
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          content: {
            badge: "Luyện Hiệu - Tỉ",
            title: "Phân biệt Tổng–Tỉ và Hiệu–Tỉ",
            table: {
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          content: {
            badge: "Ứng Dụng Bản Đồ",
            title: "1 cm trên bản đồ tỉ lệ 1 : 1 000 000 ứng với 10 km thật",
            ruler: {
              lengthCm: 10,
              measure: {
                from: 0,
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          content: {
            badge: "Phân Biệt Hai Dạng",
            title: "Xác định đúng dạng toán trước khi giải",
            table: {
