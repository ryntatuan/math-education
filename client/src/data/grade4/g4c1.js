    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          type: "visual",
          content: {
            text: "KHÁC SỐ CHỮ SỐ: số nào có nhiều chữ số hơn thì LỚN HƠN\n100 000 (6 chữ số) > 99 999 (5 chữ số)\n9 999 (4 chữ số) < 10 000 (5 chữ số)",
            table: {
              headers: ["So sánh", "Vì sao"],
              rows: [
                ["100 000 > 99 999", "6 chữ số nhiều hơn 5 chữ số"],
                ["9 999 < 10 000", "4 chữ số ít hơn 5 chữ số"],
              ],
              label:
                "Khác số chữ số: đếm chữ số trước — không cần so từng hàng",
            },
          },
        },
        {
          type: "visual",
          content: {
            text: "CÙNG SỐ CHỮ SỐ: so từng hàng, từ TRÁI sang PHẢI\n753 210 và 751 980 (đều 6 chữ số)",
            table: {
              headers: ["Hàng", "753 210", "751 980", "So sánh"],
              rows: [
                ["trăm nghìn", "7", "7", "bằng nhau"],
                ["chục nghìn", "5", "5", "bằng nhau"],
                ["nghìn", "3", "1", "3 > 1"],
              ],
              label:
                "Cùng số chữ số: so từ hàng cao nhất — hàng nghìn 3 > 1 nên 753 210 > 751 980",
            },
          },
        },
        {
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          type: "visual",
          content: {
            text: "Dãy số tự nhiên và hệ thập phân",
            table: {
        ...
        },
        {
          ...
          content: {
            ...
            options: ["99, 100, 101", "98, 100, 102", "100, 99, 98", "1, 3, 5"],
            answer: "99, 100, 101",
            mascotHint:
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          type: "visual",
          content: {
            text: "Giá trị của mỗi chữ số phụ thuộc vào HÀNG của nó",
            table: {
