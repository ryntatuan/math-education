        ...
        },
        {
          ...
          content: {
            ...
            numberLine: {
              ...
              // Trục này chỉ đủ chỗ cho bảng nhân 2 (bảng nhân 5 tới 50) ⇒ lời thích
              // phải nói đúng điều hình vẽ, không hứa “đếm thêm 5”.
              label: "Bảng nhân 2 trên trục số: đếm thêm 2 từ 2 đến 18",
            },
          },
        },
        {
      ...
      slides: [
        {
          ...
          content: {
            mascotMood: "excited",
            text: "Mỗi chiếc xe ba bánh có 3 bánh. Bé đếm bánh của 1, 2, 3 chiếc xe nhé! 🚲",
            groupScene: {
              mode: "equalGroups",
              kind: "parts",
              partKind: "wheel",
              n: 3,
              wheels: [3, 3, 3],
              captionText: "3 xe ba bánh, mỗi xe 3 bánh",
            },
          },
        },
        {
      ...
      slides: [
        {
          ...
          content: {
            ...
            groupScene: {
              ...
              n: 3,
              wheels: [4, 4, 4],
              captionText: "3 ô tô, mỗi xe 4 bánh",
            },
          },
        },
        {
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          content: {
            title: "Bé nhớ rất tốt:",
            points: ["Bé đã hoàn thành chủ đề 1.", "3 × 7 = 21; 36 : 4 = 9."],
            mascotMood: "celebrate",
          },
        },
      ],
