    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          type: "visual",
          content: {
            text: "╱ góc không vuông (ê-ke không khớp)",
            table: {
              headers: ["Góc", "Ê-ke"],
              rows: [
                ["Vuông", "khớp"],
        ...
        },
        {
          ...
          content: {
            ...
            options: ["Góc không vuông", "Góc vuông", "Góc bẹt", "Đường tròn"],
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          type: "visual",
          content: {
            text: "▭ tứ giác: 4 cạnh · 4 đỉnh · 4 góc",
            table: {
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          type: "visual",
          content: {
            text: "📦 khối hộp chữ nhật: 6 mặt không đều nhau",
            table: {
              headers: ["Khối", "Mặt"],
              rows: [
                ["Khối lập phương", "6 mặt vuông bằng nhau"],
