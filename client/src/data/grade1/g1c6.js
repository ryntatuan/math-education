export const g1c6 = {
  ...
  "description": "Số có hai chữ số, so sánh số có hai chữ số, bảng các số từ 1 đến 100",
  "icon": "💯",
  "color": "#4361ee",
  "totalLessons": 12,
  "lessons": [
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "1 chục thêm 1 đơn vị là 11. Cứ thêm 1 đơn vị thì được số tiếp theo.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            "badge": "Khám Phá",
            "title": "Số tròn chục",
            "explanation": "Số TRÒN CHỤC là số có hàng đơn vị bằng 0. Nó gồm một số nguyên chục.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Trong số có hai chữ số, chữ số ĐỨNG TRƯỚC chỉ HÀNG CHỤC, chữ số ĐỨNG SAU chỉ HÀNG ĐƠN VỊ.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé đọc SỐ CHỤC rồi đọc 'mươi', sau đó đọc số đơn vị. Riêng 1 chục thì đọc là 'mười'.",
    ...
    },
    {
      ...
      "type": "learn",
      "description": "Nhận biết số nào lớn hơn, số nào bé hơn khi cả hai số đều có hai chữ số",
      "slides": [
        {
          "type": "story",
          "content": {
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé so chữ số hàng CHỤC trước. Nếu bằng nhau thì mới so chữ số hàng ĐƠN VỊ.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Muốn tìm số lớn nhất trong một nhóm, bé so từng số một. Số lớn nhất có hai chữ số là 99; số bé nhất có hai chữ số là 10.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Số liền trước bé hơn 1 đơn vị; số liền sau lớn hơn 1 đơn vị.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bảng 100 số có 10 hàng, mỗi hàng 10 số. Đi sang phải thì thêm 1; đi xuống dưới thì thêm 10.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Trong bảng 100 số, đi xuống dưới một hàng thì số tăng thêm bao nhiêu?",
            "options": [
              1,
              9,
              10,
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Đếm thêm 1 thì đi sang phải một ô. Đếm thêm 10 thì đi xuống dưới một hàng.",
        ...
        },
        {
          ...
          "content": {
            ...
            "answer": 35,
            "mascotHint": "Thêm 10: hàng chục tăng 1, hàng đơn vị giữ nguyên → 35."
          }
        },
        {
          "type": "summary",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé xem hai số đứng cạnh nhau hơn kém nhau bao nhiêu, rồi áp dụng cho cả dãy.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé đã học: 1 chục = 10 đơn vị, các số từ 11 đến 100, hàng chục hàng đơn vị, so sánh số và bảng 100 số.",
            "points": [
