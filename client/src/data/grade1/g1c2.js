export const g1c2 = {
  ...
  "description": "Hình vuông, hình tròn, hình tam giác, hình chữ nhật; lắp ghép và xếp hình",
  "icon": "🔷",
  "color": "#f6c23e",
  "totalLessons": 8,
  "lessons": [
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            "badge": "Khám Phá",
            "title": "Hình tròn",
            "explanation": "HÌNH TRÒN có đường bao CONG, khép kín, không có cạnh và không có đỉnh.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            "badge": "Khám Phá",
            "title": "Hình chữ nhật",
            "explanation": "HÌNH CHỮ NHẬT có 4 cạnh: hai cạnh DÀI bằng nhau và hai cạnh NGẮN bằng nhau.",
        ...
        },
        {
          ...
          "content": {
            ...
            "answer": "Bốn cạnh không bằng nhau, chỉ hai dài bằng nhau và hai ngắn bằng nhau",
            "mascotHint": "Hình vuông có 4 cạnh bằng nhau; hình chữ nhật thì không."
          }
        },
        {
          "type": "summary",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Các hình phẳng có ở khắp nơi quanh bé. Bé nhìn và gọi tên hình của đồ vật.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            "badge": "Thực Hành",
            "title": "Ghép hình",
            "explanation": "Bé có thể ghép nhiều hình nhỏ thành một hình lớn hơn, hoặc cắt một hình thành nhiều hình nhỏ.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Hai hình tam giác giống nhau ghép lại có thể được hình gì?",
            "options": [
              "Hình vuông",
              "Hình tròn",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Hình ghép có nhiều hình nhỏ bên trong. Bé đếm lần lượt từng LOẠI hình để không sót.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Một ngôi nhà vẽ bằng 1 mái tam giác, 1 thân chữ nhật và 2 cửa sổ vuông. Hỏi có mấy hình vuông?",
            "shapePicture": {
              "kind": "house",
              "windows": 2,
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé đã học hình vuông, hình tròn, hình tam giác và hình chữ nhật.",
            "points": [
