export const g1c8 = {
  ...
  "description": "Cộng trừ số có hai chữ số với số có một chữ số và với số có hai chữ số — KHÔNG nhớ",
  "icon": "🔢",
  "color": "#118ab2",
  "totalLessons": 12,
  "lessons": [
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé đặt số có một chữ số thẳng cột với HÀNG ĐƠN VỊ, rồi cộng từ phải sang trái. Hàng chục giữ nguyên vì không nhớ.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé đặt tính rồi cộng. Nhớ kiểm tra hàng đơn vị có vượt 10 hay không.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Thư viện có 34 quyển truyện, cho thêm 5 quyển. Hỏi có tất cả bao nhiêu quyển truyện?",
            "options": [
              29,
              38,
              39,
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé đặt tính thẳng cột: đơn vị thẳng đơn vị, chục thẳng chục. Rồi cộng từ phải sang trái.",
    ...
    },
    {
      ...
      "slides": [
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Đội Một trồng 24 cây, đội Hai trồng 15 cây. Hỏi cả hai đội trồng được bao nhiêu cây?",
            "options": [
              29,
              38,
              39,
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé đặt số có một chữ số thẳng cột hàng đơn vị, rồi trừ từ phải sang trái. Hàng chục giữ nguyên vì không mượn.",
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bài toán 'còn lại', 'bớt đi', 'hái xuống' thì dùng phép trừ.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Trên cây có 48 quả cam, hái xuống 6 quả. Hỏi trên cây còn lại bao nhiêu quả cam?",
            "options": [
              32,
              41,
              42,
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            "badge": "Luyện Tập",
            "title": "Trừ hai số có hai chữ số",
            "explanation": "Bé đặt tính thẳng cột và trừ từng hàng từ phải sang trái.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Lớp có 46 học sinh, 24 bạn đã nộp bài. Hỏi còn bao nhiêu bạn chưa nộp bài?",
            "options": [
              12,
              22,
              24,
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé làm bốn bước: đọc đề, tìm từ khóa, đặt tính, ghi đáp số.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Mẹ mua 23 quả trứng gà và 15 quả trứng vịt. Hỏi mẹ mua tất cả bao nhiêu quả trứng?",
            "options": [
              8,
              28,
              38,
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Từ khóa 'đã bán', 'còn lại', 'bớt đi' thì dùng phép trừ.",
        ...
        },
        {
          "type": "quiz",
          "content": {
            "question": "Cửa hàng có 65 hộp sữa, đã bán 24 hộp. Hỏi còn lại bao nhiêu hộp sữa?",
            "options": [
              31,
              41,
              51,
      ...
      "slides": [
        ...
        },
        {
          ...
          "content": {
            ...
            "explanation": "Bé đã học cộng trừ số có hai chữ số với số có một chữ số và với số có hai chữ số — đều KHÔNG nhớ, KHÔNG mượn.",
            "points": [
              "Đặt tính thẳng cột.",
