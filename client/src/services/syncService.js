...
export const syncService = {
  ...
  async autoMigrateGuestDataToCloud(parentUser) {
    ...
    try {
      ...
      // Nếu đã có hồ sơ bé trên đám mây: Trả về danh sách bé
  ...
  /**
   * Tải toàn bộ dữ liệu của 1 bé từ Supabase và cập nhật vào các Zustand store
   */
    ...
    try {
      ...
      if (childProfile) {
        useUserStore.setState({
          ...
          xp: childProfile.xp,
          totalXpForNextLevel: childProfile.total_xp_for_next_level || 100,
          coins: childProfile.coins,
        })
      }

      // 2. Tải tiến độ bài học & streak
      ...
      if (progress) {
        useProgressStore.setState({
          ...
          exerciseResults: progress.exercise_results || {},
          currentStreak: progress.current_streak || 0,
          longestStreak: progress.longest_streak || 0,
          lastActiveDate: progress.last_active_date || null,
          mathRaceWins: progress.math_race_wins || 0,
          totalGamesPlayed: progress.total_games_played || 0,
        })
      }
  ...
  /**
   * Lưu nhanh tiến độ học của bé hiện tại lên Supabase
   */
