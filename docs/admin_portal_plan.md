...
- [x] Nút "Báo lỗi câu hỏi" trong App Client —
      `client/src/components/report/ReportQuestionButton.jsx`, hiện dưới **mọi slide
      câu hỏi** trong `LessonPage`. Chụp lại `lesson_id`, `slide_index`,
...
| GĐ 2      | Hỗ trợ & phân tích cơ bản | Vừa                           | GĐ 1                       | 🟡 2a + 2c code xong, chờ test — 2b chưa làm     |
