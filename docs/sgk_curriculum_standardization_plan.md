...
| Quy mô Lớp 1               | **10 chương · 97 bài · 691 slide**           | (Đợt 1.1: CĐ4 · Đợt 2: CĐ1 + CĐ2) |
| Quy mô toàn hệ thống       | **5 lớp · 51 chương · 459 bài · 2713 slide** | Khớp `MONG_DOI` (sau đợt rà CĐ2)  |
...
| Nội dung                                                                                                                                                | Nguồn                                                                                                     |
| :------------------------------------------------------------------------------------------------------------------------------------------------------ | :-------------------------------------------------------------------------------------------------------- |
| Cổng `32 PASS · 0 FAIL`; Lớp 1 = 97 bài / 691 slide; tổng 5 · 51 · 459 · 2713; `id` khớp HEAD 97/97                                                     | Đo trực tiếp ngày 2026-09-24 (cập nhật sau vòng tách hình — §8i)                                          |
...
**Cách kiểm (mới, chạy được lặp lại):** `node scratch/soat-o-trong.mjs` — soi **2713 slide / 1439
...
| :--------------- | :---------------------------------------------------------------------------------------- | --- |
| Nội dung phải rà | Lớp 1: **10 chương · 97 bài · 691 slide** (CĐ1 + CĐ2 xong — §8b, §8l)                     |     |
