...
**Mong đợi:** `6 kiểu · 2684 slide · không nuốt khoá · giữ nguyên kiểu số`.
...
**Mong đợi:** `5 lớp · 51 chương · 459 bài · 2684 slide — khớp từng khoá · canary bắt được lỗi ageRange`.
...
```
  Đọc từ file tĩnh:
    5 lớp · 51 chương · 459 bài · 2684 slide
  ✅ khớp số đã đo (5/51/459/2684)
  ✅ tất cả slide hợp lệ
```
...
>
> Cũng có cổng tự động: `npm run test:portal:static` → `S-15` kiểm **cả 2684 slide**, và
