...
> 🔢 **Quy mô nội dung hiện tại:** 5 lớp · 51 chương · **459 bài** · **2455 slide** (sau khi dựng lại chương trình Lớp 1–3 theo SGK 2026-09-21, rồi tách slide nhồi hình + thêm hình có TÊN ĐIỂM 2026-09-22). Mọi con số `362`/`1505`/`390`/`1634`/`461`/`1966` còn lại trong tài liệu là **SỐ ĐO LỊCH SỬ** tại thời điểm ghi (kể cả trong các bảng PASS đã chốt) — đọc kèm ghi chú này; dòng nào còn số cũ thì hiểu là _số tại thời điểm ghi_, không phải số đang đúng.
>
...
**Mong đợi:** `6 kiểu · 2455 slide · không nuốt khoá · giữ nguyên kiểu số`.
...
**Mong đợi:** `5 lớp · 51 chương · 459 bài · 2455 slide — khớp từng khoá · canary bắt được lỗi ageRange`.
...
```
  Đọc từ file tĩnh:
    5 lớp · 51 chương · 459 bài · 2455 slide
...
>
> Cũng có cổng tự động: `npm run test:portal:static` → `S-15` kiểm **cả 2455 slide**, và
