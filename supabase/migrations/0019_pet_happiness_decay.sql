...
--
-- ⚠️ Dán lại lần 2 CŨNG ĐƯỢC (đã thêm `IF NOT EXISTS` cho khớp 0018) — trước đây thiếu nên
--    lần 2 báo `42701` và dừng giữa file.
--
...
ALTER TABLE public.child_pets ADD COLUMN IF NOT EXISTS last_happy_time TIMESTAMPTZ;
